...
CURRENT_RUNTIME_KERNEL_STEP_COUNT=12
...
PAVP_NAIVE_COLLAPSIBLE_MULTILEVEL_NAVIGATION_REWORK_REPOSITORY_IMPLEMENTATION=COMPLETE
PAVP_NAIVE_COLLAPSIBLE_MULTILEVEL_NAVIGATION_REWORK_STATIC_VERIFICATION=PASS
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_ADMISSION_AMENDMENT=FROZEN
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_STATUS=ACCEPTED
...
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_OWNER_RUNTIME_ACCEPTANCE=PASS
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_OWNER_VISUAL_ACCEPTANCE=PASS
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_OWNER_ACCESSIBILITY_ACCEPTANCE=NOT_PERFORMED
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_OWNER_ACCEPTANCE_STATEMENT=效果还可以 可以接受
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_IMPLEMENTATION_COMMIT=b6efbb608b309f601217a2765150bd9ec217cf78
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_PUBLICATION_TARGET=origin/main
...
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_OWNER_RUNTIME_ACCEPTANCE=PASS
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_OWNER_VISUAL_ACCEPTANCE=PASS
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_OWNER_ACCESSIBILITY_ACCEPTANCE=NOT_PERFORMED
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_OWNER_ACCEPTANCE_STATEMENT=完美 通过了，越来越好了
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_IMPLEMENTATION_COMMIT=083b527b567287544b3786cd4350ee713f6a59f3
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_PUBLICATION_TARGET=origin/main
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_PUBLICATION_STATUS=COMPLETE
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_RELEASE_STATUS=NOT_RELEASED
PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_ADMISSION_AMENDMENT=FROZEN
PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_REWORK_STATUS=OPEN
PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_REWORK_REPOSITORY_IMPLEMENTATION=COMPLETE
PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_REWORK_STATIC_VERIFICATION=PASS
PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_ADMISSION_AMENDMENT=FROZEN
PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_REWORK_STATUS=OPEN
PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_REWORK_REPOSITORY_IMPLEMENTATION=COMPLETE
PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_REWORK_STATIC_VERIFICATION=PASS
PAVP_ADMIN_NAVIGATION_VISIBLE_HOVER_AND_UNIFIED_SELECTED_REVEAL_ADMISSION_AMENDMENT=FROZEN
PAVP_ADMIN_NAVIGATION_VISIBLE_HOVER_AND_UNIFIED_SELECTED_REVEAL_REWORK_STATUS=OPEN
PAVP_ADMIN_NAVIGATION_VISIBLE_HOVER_AND_UNIFIED_SELECTED_REVEAL_REWORK_REPOSITORY_IMPLEMENTATION=NOT_STARTED
PAVP_ADMIN_NAVIGATION_VISIBLE_HOVER_AND_UNIFIED_SELECTED_REVEAL_REWORK_STATIC_VERIFICATION=NOT_RUN
PAVP_ADMIN_NAVIGATION_NATIVE_NAIVE_SIMPLIFICATION_ADMISSION_AMENDMENT=FROZEN
PAVP_ADMIN_NAVIGATION_NATIVE_NAIVE_SIMPLIFICATION_STATUS=ACCEPTED
PAVP_ADMIN_NAVIGATION_NATIVE_NAIVE_SIMPLIFICATION_REPOSITORY_IMPLEMENTATION=COMPLETE
PAVP_ADMIN_NAVIGATION_NATIVE_NAIVE_SIMPLIFICATION_STATIC_VERIFICATION=PASS
...
```text
AMENDMENT=PAVP_DARK_ACTION_COLOR_HARMONY_REFINEMENT_ADMISSION_AMENDMENT
AMENDMENT_KIND=ARCHITECTURE_ONLY_BOUNDED_PUBLIC_ROLE_CONTRACT_RECONCILIATION
AMENDMENT_STATUS=FROZEN
NORMATIVE_WRITE_AUTHORITY=ARCHITECTURE.md
SOURCE_IMPLEMENTATION_IN_THIS_AMENDMENT=PROHIBITED
SOURCE_IMPLEMENTATION_AUTHORITY=PAVP_DARK_ACTION_COLOR_HARMONY_REFINEMENT_ONLY_UNDER_THIS_FROZEN_CONTRACT
ACTIVATION_EFFECT=CANONICAL_WORK_PACKAGE_ADMISSION_ONLY
WORK_PACKAGE=PAVP_DARK_ACTION_COLOR_HARMONY_REFINEMENT
PARENT_WORK_PACKAGE=PAVP_ARCHITECTURE_ADMIN_CONSOLE_PRODUCT_EXPERIENCE_REWORK
...
SUCCESSOR_PACKAGE_AUTHORIZATION=NONE
NEW_CAPABILITY_STATUS_ENUM=PROHIBITED
ROLE_SEPARATION=ACTION_FILL_ON_ACTION_CONTENT_CONTROL_FOREGROUND
ACTION_FILL_ROLE_ID=color.action.primary
ACTION_FILL_RESPONSIBILITY=filled primary-action backgrounds only
ACTION_FILL_CSS_VARIABLE=--ui-color-action-primary
ACTION_FILL_UNOCSS_CLASS=bg-action-primary
ACTION_FILL_UNOCSS_PROPERTY=background-color
ACTION_CONTENT_ROLE_ID=color.text.on-action
ACTION_CONTENT_RESPONSIBILITY=text and icons on color.action.primary
CONTROL_FOREGROUND_ROLE_ID=color.control.primary
CONTROL_FOREGROUND_RESPONSIBILITY=primary control and accent foreground on page and panel surfaces
CONTROL_FOREGROUND_MUST_NOT_BE_FILLED_ACTION_BACKGROUND=YES
ACTION_FILL_MUST_NOT_BE_CONTROL_PRIMARY_CONTRAST_FOREGROUND=YES
ACTION_CONTENT_NAMED_CONTRAST_ID=action-content-on-primary
ACTION_CONTENT_NAMED_CONTRAST_FOREGROUND=color.text.on-action
ACTION_CONTENT_NAMED_CONTRAST_BACKGROUND=color.action.primary
ACTION_CONTENT_NAMED_CONTRAST_KIND=normal-text
STANDARD_ACTION_PRIMARY_MAXIMUM_OKLCH_LIGHTNESS=0.50
STANDARD_TEXT_ON_ACTION_MINIMUM_OKLCH_LIGHTNESS=0.94
ENHANCED_ACTION_PRIMARY_MAXIMUM_OKLCH_LIGHTNESS=0.38
ENHANCED_TEXT_ON_ACTION_MINIMUM_OKLCH_LIGHTNESS=0.985
ENHANCED_ACTION_PRIMARY_LIGHTNESS_RELATION=STRICTLY_LOWER_THAN_STANDARD
ENHANCED_TEXT_ON_ACTION_LIGHTNESS_RELATION=GREATER_THAN_OR_EQUAL_TO_STANDARD
STANDARD_ACTION_CONTENT_NAMED_CONTRAST_MINIMUM=4.5
ENHANCED_ACTION_CONTENT_NAMED_CONTRAST_MINIMUM=7
CONTROL_PRIMARY_ON_PAGE_NAMED_CONTRAST_ID=control-primary-on-page
CONTROL_PRIMARY_ON_PAGE_FOREGROUND=color.control.primary
CONTROL_PRIMARY_ON_PAGE_BACKGROUND=color.surface.page
CONTROL_PRIMARY_ON_PAGE_KIND=non-text
CONTROL_PRIMARY_ON_PAGE_STANDARD_MINIMUM=3
CONTROL_PRIMARY_ON_PAGE_ENHANCED_MINIMUM=3
CONTROL_PRIMARY_ON_PANEL_NAMED_CONTRAST_ID=control-primary-on-panel
CONTROL_PRIMARY_ON_PANEL_FOREGROUND=color.control.primary
CONTROL_PRIMARY_ON_PANEL_BACKGROUND=color.surface.panel
CONTROL_PRIMARY_ON_PANEL_KIND=non-text
CONTROL_PRIMARY_ON_PANEL_STANDARD_MINIMUM=3
CONTROL_PRIMARY_ON_PANEL_ENHANCED_MINIMUM=3
DARK_CONTROL_PRIMARY_MINIMUM_CONTRAST_ON_PAGE=3
DARK_CONTROL_PRIMARY_MINIMUM_CONTRAST_ON_PANEL=3
DARK_CONTROL_PRIMARY_ACTION_FILL_LIGHTNESS_CAP_APPLICABILITY=NONE
OPPOSITE_ROLE_FAMILY_SINGLE_VALUE_REQUIREMENT=NONE
ACTION_PRIMARY_HUE_IDENTITY=PRESERVE_EACH_THEME_EXISTING_ACTION_HUE_FAMILY
TEXT_ON_ACTION_HUE_IDENTITY=PRESERVE_EACH_THEME_EXISTING_TEXT_HUE_FAMILY
TARGET_VALUE_AUTHORING=MANUAL_EXPLICIT_ABSOLUTE_OKLCH_PER_THEME
TARGET_VALUE_GAMUT=SRGB_ONLY
AUTOMATIC_PALETTE_DERIVATION=PROHIBITED
AUTOMATIC_CONTRAST_CORRECTION=PROHIBITED
GAMUT_REMAP=PROHIBITED
LIGHT_ACTION_PRIMARY_CHANGE=NONE
LIGHT_TEXT_ON_ACTION_CHANGE=NONE
...
PREFERENCE_FIRST_PAINT_STORAGE_OR_PROVIDER_CHANGE=NONE_IN_THIS_ARCHITECTURE_GOVERNANCE_TASK
...
```text
CONTROL_PRIMARY_PUBLIC_ROLE_ID=color.control.primary
CONTROL_PRIMARY_PUBLIC_ROLE_TOKEN_TYPE=color
CONTROL_PRIMARY_PUBLIC_ROLE_CATEGORY=color
CONTROL_PRIMARY_PUBLIC_ROLE_VISIBILITY=public
CONTROL_PRIMARY_PUBLIC_ROLE_ADMISSION_PHASE=1
CONTROL_PRIMARY_PUBLIC_ROLE_CSS_VARIABLE=--ui-color-control-primary
CONTROL_PRIMARY_PUBLIC_ROLE_THEME_PLANE_APPLICABILITY=target-required-after-atomic-cutover
CONTROL_PRIMARY_PUBLIC_ROLE_CONTRAST_ENDPOINT_ID=color.control.primary
CONTROL_PRIMARY_PUBLIC_ROLE_ALPHA_CONTRACT_ID=null
CONTROL_PRIMARY_PUBLIC_ROLE_UNOCSS_GENERATOR_KIND=exact-rule
CONTROL_PRIMARY_PUBLIC_ROLE_UNOCSS_FAMILY=color
CONTROL_PRIMARY_PUBLIC_ROLE_UNOCSS_KEY=control-primary
...
TARGET_UNOCSS_MAPPING_COUNT=37
TARGET_NAMED_CONTRAST_RECORD_COUNT=14
TARGET_ALPHA_RECORD_COUNT=1
TARGET_DENSITY_RECORD_COUNT=3
TARGET_BUILT_IN_THEME_COUNT=14
TARGET_FIRST_PAINT_RECORD_COUNT=1
TARGET_THEME_PLANE_COUNT=56
TARGET_PUBLIC_THEME_COLOR_CELL_COUNT=560
TARGET_COMPLETE_THEME_SCHEMA_VERSION=3
TARGET_COMPLETE_THEME_ROLE_CONTRACT_VERSION=2
TARGET_MANIFEST_SCHEMA_VERSION=9
TARGET_MANIFEST_RECORD_COUNT=252
TARGET_MANIFEST_BASELINE_RECORD_COUNT=181
TARGET_MANIFEST_EXPECTED_RECORD_COUNT_DELTA=71
TARGET_DEFAULT_THEME=built-in:iris
TARGET_FIRST_PAINT_SAFE_THEME=built-in:iris
TARGET_VERSION_2_THEME_PLANE_ROLE_ORDER=color.action.primary,color.control.primary,color.border.default,color.focus.ring,color.scrim.viewport,color.surface.page,color.surface.panel,color.text.on-action,color.text.primary,color.text.secondary
VERSION_2_BUILT_IN_THEME_MIGRATION=ATOMIC_ALL_FOURTEEN
VERSION_2_THEME_PLANE_MIGRATION=ATOMIC_ALL_FIFTY_SIX
PARTIAL_VERSION_2_THEME=INVALID
TARGET_ADDED_CONTROL_PRIMARY_CELL_COUNT=56
TARGET_DARK_ACTION_PAIR_REFINED_CELL_COUNT=56
UNCHANGED_PRE_EXISTING_PUBLIC_THEME_COLOR_CELL_COUNT=448
LEGACY_CUSTOM_THEME_ROLE_CONTRACT_VERSION=1
LEGACY_CUSTOM_THEME_COMPATIBILITY_OWNER=existing Design-System-owned compatibility boundary
LEGACY_CUSTOM_THEME_COMPATIBILITY_PROJECTION=color.control.primary equals legacy color.action.primary
LEGACY_CUSTOM_THEME_COMPATIBILITY_MODE=IN_MEMORY_READ_ONLY
LEGACY_CUSTOM_THEME_STORAGE_REWRITE=PROHIBITED
LEGACY_CUSTOM_THEME_REGISTRY_CLEANUP=PROHIBITED
LEGACY_CUSTOM_THEME_DATA_DELETION=PROHIBITED
LEGACY_CUSTOM_THEME_NEW_STORAGE_KEY=NONE
LEGACY_CUSTOM_THEME_NEW_PERSISTENCE_ENVELOPE=NONE
LEGACY_CUSTOM_THEME_PAGE_OWNED_MIGRATION=PROHIBITED
...
OWNER_ACCEPTANCE_STATEMENT=验收通过
PRODUCTION_RELEASE_STATUS=NOT_RELEASED
IMPLEMENTATION_COMPLETION_EVIDENCE=one scoped source and generated diff limited to the admitted existing owners; every source and generated gate passes; no dependency, lockfile, browser, test, fixture, screenshot, trace or evidence artifact; exact published implementation commit 5673236868737f42f3470307b5f5d6c8d4e8639e received Owner runtime and visual acceptance without constituting an overall Admin Console or production release acceptance
```
...
`expandedKeys` 初始包含六个 group key，`accordion=false`。Expanded 时用户可独立开合 group；route change 必须通过不写回用户开合状态的派生受控投影保证 active route parent 被包含。Rail collapse 不销毁内存状态，再展开恢复；该状态只属于 Shell instance，不持久化。
...
Naive `layoutDark.self(mergedCommon)` 会在 Component-local visual override 合并前执行 `composite(bodyColor, scrollbarColor)`。Global PAVP `common.bodyColor` 是 Runtime CSS Custom Property，不能进入该 `seemly` eager Color Parser；因此 `themeOverrides.Layout.common` 必须精确只含 `bodyColor: commonDark.bodyColor`，以 Vendor concrete body color 作为 Light/Dark 共用、Private、不可见的 Parser-compatible Intermediate Input。该输入不改变全局 PAVP `common.bodyColor`，不成为 Light/Dark 或 PAVP Visual Authority；当前可见 `Layout.color`、`textColor`、`siderColor`、`siderBorderColor` 仍必须由下方 Exact PAVP Map 覆盖，`showTrigger=false` 的 Sider toggle 派生值仍不可见。禁止删除该窄 Bridge、把 CSS Variable 传回 Layout Common、替换 `layoutDark`、加入 raw visual literal 或扩大为通用 Naive compatibility layer。
...
只有既有 project/UI configuration checker 的精确 frozen import/source inventory 确需同步时才可修改对应 checker。本次明确且唯一的 `apps/web/**` 例外是由既有 canonical generator 确定性同步 `apps/web/src/generated/engineering-manifest.ts` 的 Initial JavaScript budget mirror；除该单一生成差异外，不得修改其他 `apps/web/**`、Route Registry、Router Runtime、Runtime Kernel、Storage、Appearance Store/Persistence、Design System token source/generated artifacts、built-in Theme JSON、Public UI Registry、public `@platform/ui` API、package manifest、`pnpm-lock.yaml`、Vite 或 workflow。

#### Dependency 与 Bundle Gate

旧包实施时不增加 dependency、manifest、lockfile、Styled Vendor 或 icon package；坐标保持 `naive-ui@2.45.2`。完整私有 `NLayout + NLayoutSider + NMenu` 实现已证明 Initial JavaScript 增量来自 startup-critical Menu、Submenu 与 Dropdown runtime closure，而不是 aggregate runtime import、完整 Naive `darkTheme` 或重复 Naive copy。多级菜单、折叠 Dropdown、键盘、焦点、Theme 与 Motion 行为全部保持必要；异步隐藏真实 startup code、删除行为、改变 gzip/Release SHA/initial static-import measurement 或放宽最低 headroom 均被拒绝。§1.2B.0I 只对同一最终 Navigation Closure 增加精确一个 private GSAP Adapter Lazy Root；任何第二个或其他 Non-route Dynamic Root 仍被拒绝。
...
CURRENT_INITIAL_JAVASCRIPT_BUDGET=229376
INITIAL_JAVASCRIPT_BUDGET_DELTA=45056
MINIMUM_INITIAL_JAVASCRIPT_HEADROOM=8192
MAXIMUM_ALLOWED_INITIAL_JAVASCRIPT=221184
...
ENGINEERING_MANIFEST_BUDGET_MIRROR=229376
```

本次 Owner Budget Rebaseline 只把唯一 hard-budget authority 从 `180 * 1024` 调整为 `224 * 1024`，并由既有 Engineering Manifest generator 同步单一 mirror；历史 `PAVP_INITIAL_JAVASCRIPT_HEADROOM_RECOVERY` 的 `184320` 当时预算与已提交 measurement 继续作为明确历史事实保留，不被改写。现行 hard budget 为 `229376 bytes gzip`，至少保留 `8192 bytes gzip` headroom，因此最终实现不得超过 `221184 bytes gzip`。

#### Static Governance Contract

当前 owning source gate 证明以下 59 项：
...
59. `Layout.common.bodyColor` 保持唯一 Vendor-concrete eager-parser compatibility input，最终可见 Layout/Sider 字段仍由 PAVP authority 覆盖。

当前 source checker 提供以下 23 个可逆 in-memory probe：
...
23. 删除 Layout `bodyColor` eager-parser compatibility bridge。

Budget Rebaseline 与 deterministic Engineering Manifest mirror 另由以下精确 6 个可逆 in-memory probe 保护：

1. 把 active hard budget 恢复为 `184320`。
2. 把 minimum Initial JavaScript headroom 降到 `8192` 以下。
3. 把 hard budget 再提高到 `229376` 以上。
4. 在精确 GSAP Adapter Lazy Root 之外增加第二个 non-route dynamic Navigation import。
5. 把 exact Route lazy count 从 `17` 改走。
6. 把 generated Engineering Manifest mirror 留在 `184320`。

六个 budget/generated-mirror probe 与既有 23 个 Navigation source probe 都只修改内存快照、因目标原因失败、完整恢复且零 Repository Artifact。`scripts/verify/check-bundle.ts` 的 minimum-headroom constant、initial static-import traversal、gzip options、Release SHA normalization、dynamic-import comparison、exact 17-route closure 与 per-route budget 保持不变；§1.2B.0I 源码 Landing 后的完整 SHA-256 精确为 `30e618541feb287a82a88076045d232091fb3eabaeb499fb2aae8da3fb1fd372`，并新增精确一个 Motion Root 的 disjoint unique-static-closure measurement。

#### Admission Checker 与状态转换

本 Amendment 的 owning checker 同步 current-work、Navigation source、Budget Rebaseline 与 generated-mirror governance，继续拒绝 unknown ID、missing/mixed mirror、RUNTIME-003 regression、overall acceptance restoration 与 successor authorization。它保留 6 个 Architecture admission-state reversible in-memory probes：Current Work 留为 `NONE`、unauthorized Current Work ID、Repository Implementation 从 `COMPLETE` 回退、Static Verification 从 `PASS` 回退、RUNTIME-003 从 `ACCEPTED` 回退、overall Admin Console acceptance 伪恢复；每个 probe 只修改内存文本、因目标原因失败并零落盘。

源码实施前，本 Work Package 精确保持 `OPEN / NOT_STARTED / NOT_RUN`。本次原子源码实现、显式 Budget Rebaseline、Engineering Manifest 确定性同步和完整 canonical static gate 成功后，Work Package 仍为 `OPEN`，Repository Implementation 为 `COMPLETE`、Static Verification 为 `PASS`；不引入 pending-owner status。Runtime/Visual/Accessibility Owner acceptance 仍是后续明确 external decision。

### 1.2B.0I `PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_REWORK`

本 Amendment 响应 Owner 对既有导航高亮方式、折叠控制位置与交互质感的明确否定和重新实施授权。Architecture-only Landing 先冻结一个实例级 GSAP 例外与原子源码实施合同；随后授权的源码 Landing 已按该合同完成 Dependency、Private Adapter、Shell、Naive Projection、Bundle Gate 与确定性 Engineering Manifest Mirror，同样不恢复整体 Admin Console 验收。

```text
AMENDMENT=PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_ADMISSION_AMENDMENT
AMENDMENT_KIND=ARCHITECTURE_ONLY_BOUNDED_INSTANCE_GSAP_ADMISSION
AMENDMENT_STATUS=FROZEN
NORMATIVE_WRITE_AUTHORITY=ARCHITECTURE.md
SOURCE_IMPLEMENTATION_IN_THIS_AMENDMENT=PROHIBITED
ACTIVATION_EFFECT=CANONICAL_WORK_PACKAGE_ADMISSION_ONLY
SOURCE_IMPLEMENTATION_AUTHORITY=PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_REWORK_ONLY_UNDER_THIS_FROZEN_CONTRACT
WORK_PACKAGE=PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_REWORK
WORK_PACKAGE_CLASSIFICATION=BOUNDED_ADMIN_NAVIGATION_VISUAL_AND_INSTANCE_MOTION_REWORK
...
#### Current Work 串行重排与旧包证据保留

```text
PREVIOUS_CURRENT_BOUNDED_WORK_AUTHORITY=PAVP_NAIVE_COLLAPSIBLE_MULTILEVEL_NAVIGATION_REWORK_ADMISSION_AMENDMENT
PREVIOUS_CURRENT_BOUNDED_WORK=PAVP_NAIVE_COLLAPSIBLE_MULTILEVEL_NAVIGATION_REWORK
...
PREVIOUS_CURRENT_BOUNDED_WORK_OWNER_VISUAL_ACCEPTANCE=REJECTED_FOR_ACTIVE_INDICATOR_AND_COLLAPSE_CONTROL_PLACEMENT
...
`PAVP_NAIVE_COLLAPSIBLE_MULTILEVEL_NAVIGATION_REWORK` 的 `OPEN / COMPLETE / PASS` 是已完成源码与静态门的历史事实，不是 Owner Visual Acceptance，也不得改写为 `ACCEPTED`、`NOT_STARTED` 或 `NOT_RUN`。新包串行接管同一 Navigation Source Closure，保留旧实现作为可审计基线；两个包不得并行成为 Current Work。
...
GSAP_INSTANCE_ADMISSION=PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_REWORK_ONLY
...
本例外只替换 §24.2(2) 对该精确 Work Package 的判定来源；§24.2(1)、(3) 至 (7) 保持强制。`GSAP_STATUS=DEFERRED` 继续表示平台没有通用 GSAP Capability，§24 的全局技术优先级保持不变，任何其他组件、页面、Interaction 或未来包都不得继承本例外。

#### 视觉与布局合同

```text
EXPANDED_ROOT_ACTIVE_PRESENTATION=FOREGROUND_ONLY
EXPANDED_ROOT_ACTIVE_SURFACE=NONE
EXPANDED_ROOT_LEFT_ACTIVE_INDICATOR=PROHIBITED
EXPANDED_ROOT_ACTIVE_OUTLINE=PROHIBITED
EXPANDED_ROOT_ACTIVE_BADGE=PROHIBITED
LEVEL_2_ACTIVE_SURFACE=INSET_OVERLAY_MATERIAL
LEVEL_2_ACTIVE_EXPLICIT_INDICATOR=ONE_TRAILING_CONTROL_PRIMARY_DOT
LEVEL_2_ACTIVE_LEFT_INDICATOR=PROHIBITED
ACTIVE_EXPLICIT_INDICATOR_COUNT_PER_SELECTED_ROUTE=1
ACTIVE_DOT_COLOR_AUTHORITY=color.control.primary
ACTIVE_DOT_ACCESSIBILITY=ARIA_HIDDEN_DECORATION
ACTIVE_ROUTE_SEMANTIC_AUTHORITY=aria-current
COLLAPSED_ROOT_ACTIVE_SURFACE=COMPACT_CENTERED_OVERLAY_MATERIAL
COLLAPSED_ROOT_ACTIVE_INDICATOR=ONE_SMALL_TRAILING_OR_CORNER_CONTROL_PRIMARY_DOT
COLLAPSED_ROOT_LEFT_ACTIVE_INDICATOR=PROHIBITED
NAVIGATION_HOVER_PRESENTATION=EXISTING_LOW_CONTRAST_NAVIGATION_HOVER_SURFACE_ONLY
TOP_NAVIGATION_COLLAPSE_CONTROL=PROHIBITED
COLLAPSE_CONTROL_PLACEMENT=BOTTOM_UTILITY_DOCK
COLLAPSE_CONTROL_EXPANDED_CONTENT=ICON_AND_收起导航
COLLAPSE_CONTROL_COLLAPSED_CONTENT=ICON_ONLY
COLLAPSE_CONTROL_DIVIDER=EXISTING_TOKEN_OWNED_HAIRLINE
NEW_VISUAL_TOKEN=NONE
NEW_MATERIAL_AUTHORITY=NONE
```

Expanded Root Active 只能提升 Icon、Text 与 Chevron Foreground，不得出现左侧竖条、整行 Active Fill、Outline 或 Badge。实际 Level-2 Active Route 使用内嵌 Overlay Material 与唯一末端 `color.control.primary` 圆点；圆点为装饰，`aria-current` 继续是语义权威。Collapsed Root 可使用紧凑、居中的 Overlay Surface 与一个小圆点，但仍不得出现左侧高亮条。Wide Collapse Action 从顶部移到底部 Utility Dock；Regular 与 Narrow 既有 Profile、Drawer、Route、Focus、Scroll 与 Keyboard 所有权不变。

#### 命名交互、档位与生命周期

```text
GSAP_NAMED_PRODUCTION_INTERACTION_COUNT=2
GSAP_NAMED_PRODUCTION_INTERACTION_IDS=admin-navigation.wide-collapse-bottom-dock;admin-navigation.route-selection-inset-surface
GSAP_INTERACTION_OWNER_COMPONENT=packages/ui/src/components/UiAdminShell.vue
GSAP_INTERACTION_OWNER_ADAPTER=packages/ui/src/adapters/gsap/admin-navigation-motion.ts
CSS_BASELINE_ONLY_INTERACTION=admin-navigation.bottom-dock-feedback
...
GSAP_VENDOR_DOM_OWNERSHIP=NONE
GSAP_PERSISTENT_SIDER_GEOMETRY_OWNERSHIP=NONE
GSAP_ROUTE_HOST_GEOMETRY_OWNERSHIP=NONE
GSAP_INPUT=explicit PAVP-owned HTMLElement references only
GSAP_DOM_QUERY=PROHIBITED
GSAP_VENDOR_DOM_PATCH=PROHIBITED
GSAP_SCROLL_TRIGGER=PROHIBITED
GSAP_PLUGIN_REGISTRATION=PROHIBITED
GSAP_FULL_BEHAVIOR=token-duration and token-easing PAVP-owned micro-transition with immediate semantic state commit
GSAP_REDUCED_BEHAVIOR=short opacity-only presentation with no displacement or scale
GSAP_NONE_BEHAVIOR=immediate final state and complete animation disposal
MOTION_RESULT_PARITY=REQUIRED
ACCESSIBLE_NAME_UPDATE=IMMEDIATE_WITH_STATE_NOT_ANIMATION_COMPLETION
FOCUS_TRANSFER_BY_MOTION=PROHIBITED
READING_ORDER_CHANGE_BY_MOTION=PROHIBITED
GSAP_INSTANCE_OWNER=ONE_PER_UI_ADMIN_SHELL_INSTANCE
GSAP_ACTIVE_TIMELINE_COUNT_PER_INTERACTION=AT_MOST_ONE
GSAP_NEW_INPUT_POLICY=INTERRUPT_CURRENT_AND_CONTINUE_FROM_CURRENT_RENDERED_STATE
GSAP_REVERSAL_POLICY=REVERSE_WHEN_TARGET_RETURNS_TO_PRIOR_STABLE_STATE
GSAP_ROUTE_CHANGE_POLICY=CANCEL_SELECTION_PRESENTATION_AND_COMMIT_CURRENT_ROUTE_STATE
GSAP_PREFERENCE_CHANGE_POLICY=CANCEL_REVERT_AND_ENTER_NEW_FULL_REDUCED_OR_NONE_BRANCH
GSAP_VISIBILITY_LOSS_POLICY=CANCEL_REVERT_AND_COMMIT_STABLE_CURRENT_STATE
GSAP_COMPONENT_UNMOUNT_POLICY=KILL_ALL_AND_REVERT_CONTEXT
GSAP_APPLICATION_DISPOSAL_POLICY=KILL_ALL_AND_REVERT_CONTEXT
GSAP_INLINE_STYLE_CLEANUP=REQUIRED_FOR_PAVP_OWNED_MOTION_ELEMENTS
GSAP_PERMANENT_WILL_CHANGE=PROHIBITED
GSAP_TIMER_OR_RAF_OWNERSHIP=NONE
GSAP_GESTURE_DISPOSAL=NOT_APPLICABLE_NO_GESTURE
GSAP_NATIVE_SCROLL=PRESERVED
GSAP_SCROLL_HIJACKING=PROHIBITED
GSAP_CUSTOM_SCROLLER=PROHIBITED
GSAP_CUSTOM_SCROLLBAR=PROHIBITED
PRIVATE_MOTION_DOCUMENT_VISIBILITY_LISTENER_COUNT=1
PRIVATE_MOTION_DOCUMENT_VISIBILITY_LISTENER_OWNER=admin-navigation-motion adapter
PRIVATE_MOTION_VISIBILITY_LISTENER_CLEANUP=REQUIRED
GLOBAL_POINTER_LISTENER=PROHIBITED
GLOBAL_KEYBOARD_LISTENER=PROHIBITED
GSAP_LAZY_LOAD_FAILURE_POLICY=COMMIT_STABLE_FINAL_STATE_WITHOUT_RETRY_LOOP
GSAP_LAZY_LOAD_FAILURE_NEW_ERROR_AUTHORITY=NONE
GSAP_LAZY_LOAD_FAILURE_NAVIGATION_BLOCKING=PROHIBITED
```

Semantic State、Collapsed State 与 Route State 必须先同步提交；Motion 只表现已提交状态。Level-2 inset Overlay surface 始终由 Naive Theme/CSSR 持有，GSAP 不写 Surface、Border、Sider/Menu Width 或 Route Geometry。普通 Hover、Pressed 与 Focus-visible 保持现有 CSS Motion Baseline，不使用 GSAP。任何新输入、Route Change、Motion Preference Change、Visibility Loss、Unmount 或 Application Disposal 都必须杀死当前 Timeline、撤销 Adapter 临时样式并提交稳定状态；不得留下 Inline Style、Transform、`will-change`、Callback、Listener、Timer、RAF 或 Promise。

#### Dependency、私有 Adapter 与 Lazy Root
...
GSAP_LOCK_PACKAGE_INTEGRITY=sha512-dMW4CWBTUK1AEEDeZc1g4xpPGIrSf9fJF960qbTZmN/QwZIWY5wgliS6JWl9/25fpTGJrMRtSjGtOmPnfjZB+A==
...
GSAP_ADAPTER_LAZY_IMPORT_OWNER=packages/ui/src/components/UiAdminShell.vue
...
`UiAdminShell` 只动态导入精确私有 Adapter；Adapter 内部静态导入 `gsap`，因此 Vendor 进入该 Lazy Root 的静态 Closure 而不进入 Initial JavaScript。应用、Public Root、其他 Package 与其他 Adapter 不得直接或动态导入 GSAP。禁止 Deep Import、CDN、Script Injection、Plugin 和第二 Dynamic Motion Root。

#### Bundle 与 Engineering Manifest 合同
...
MOTION_ADAPTER_BUDGET_EXCEED_ACTION=STOP_AND_REQUIRE_SEPARATE_ARCHITECTURE_DECISION_AND_ADR
MOTION_ADAPTER_BUNDLE_MEASUREMENT=PRODUCTION_EMITTED_UNIQUE_STATIC_CLOSURE_GZIP
MOTION_ADAPTER_INITIAL_CHUNK_INTERSECTION=PROHIBITED
MOTION_ADAPTER_ROUTE_ROOT_INTERSECTION=PROHIBITED
MOTION_ADAPTER_DYNAMIC_CHILD_ROOT=PROHIBITED
...
CHECK_BUNDLE_SHA256=30e618541feb287a82a88076045d232091fb3eabaeb499fb2aae8da3fb1fd372
```

当前实现已在 `project.config.ts.bundleBudgets` 建立唯一 `40960 bytes gzip` Motion Adapter hard-budget authority，并由既有 Engineering Manifest generator 确定性产生 `lazy-motion-adapter-javascript-gzip` Mirror。当前 `check-bundle.ts` 证明 Dynamic Root Set 精确为 17 Route Roots 加 1 Motion Root，Motion Root 的唯一静态 JavaScript Closure 为 1 个 emitted file、`28771 bytes gzip`，与 Initial/Route Closure 零相交且无 Dynamic Child；Initial JavaScript 为 `211177 bytes gzip`、Headroom 为 `18199 bytes gzip`，Initial CSS 为 `24729 bytes gzip`。超过 `40960` 仍必须停止，不得在本包提高 Budget 或伪造 ADR。

#### 两阶段允许路径

Architecture-only Stage 只允许：
...
Architecture-only Stage 禁止 Dependency、Manifest、Lockfile、Project Configuration、UI、Runtime、Bundle Checker、Generated Output、Workflow、Test、Browser、Screenshot、Trace 与 Evidence Artifact 修改。
...
scripts/architecture/check-engineering-manifest.ts
scripts/verify/check-project-config.ts
scripts/verify/check-bundle.ts
apps/web/src/generated/engineering-manifest.ts
```

`naive-menu.ts` 只有在精确 Private Render/Type Bridge 确需同步时才可修改。除确定性 Engineering Manifest Output 外，其他 `apps/web/**`、Root `package.json`、Public UI Root/Registry、Route Registry、Router Runtime、Runtime Kernel、Storage、Appearance Store/Persistence、Design System Token Source/Generated Token、Built-in Theme、Vite、Workflow、Test 与 Browser Infrastructure 均禁止。

#### Architecture Admission Gate

Owning Checker 保持旧导航包 13 份 `FROZEN / OPEN / COMPLETE / PASS` 历史证据，并把 13 份 Current Work Mirror 精确收口到新包的 `FROZEN / OPEN / COMPLETE / PASS`。既有 12 个 admission-state 可逆 in-memory probe 保持：

1. Current Work 留在旧导航包。
2. Current Work 改为 Unauthorized ID。
3. 新 Amendment 从 `FROZEN` 回退。
4. 新包 Repository Implementation 从 `COMPLETE` 回退为 `NOT_STARTED`。
5. 新包 Static Verification 从 `PASS` 回退为 `NOT_RUN`。
6. 把全局 `GSAP_STATUS=DEFERRED` 改成 `ACTIVE`。
7. 把 `gsap@3.15.0` 改走。
8. 把唯一 Motion Root Count 从 `1` 改为 `2`。
9. 把 Motion Adapter Budget 从 `40960` 提高。
10. 允许并行重叠 Navigation Implementation。
11. 允许 Application direct GSAP import。
12. 把旧导航 Repository Implementation 从 `COMPLETE` 回退。

每个 admission-state probe 只修改内存 Source、因目标 Failure Code 失败、完整恢复且零落盘 Artifact。旧导航的 59 项 Source Invariant、23 个 Source Probe 与 6 个 Budget Probe 继续保护已实现基线；其中旧 Budget Gate 只允许精确一个 `../adapters/gsap/admin-navigation-motion` Lazy Root，并继续拒绝任何额外 Dynamic Root。

本包另增加精确 12 项稳定 Source Invariant：唯一 Shell Lazy Import 与 Adapter static `gsap` owner，并保持 Private/Public/Application Boundary；底部 Utility Dock 结构；Route Dot 装饰语义；Expanded Root foreground-only 与 Naive-owned Level-2 Overlay；Collapsed/Dropdown pseudo-dot 及 Reduced/None `scale(1)`；显式 HTMLElement target 且零 Vendor DOM query；GSAP 仅写 opacity/visibility 与 Full-only scale；Full/Reduced/None 结果同态；新输入中断并从当前 rendered state 继续；唯一 Visibility listener 与对称 cleanup；Unmount/disposal 与 lazy fallback 清理；零 Timer/RAF/Plugin/Pointer/Keyboard Global Side Effect。对应 12 个可逆 Source Probe 精确移除或破坏上述每一类稳定合同，不冻结 private helper 名、循环、局部容器或 easing parser decomposition。

源码 Landing 完成后的最终 gate 包含 Owning Checker、`check:arch`、Formatting、Lint、Vue Typecheck、Production Build、精确 18-root Bundle Gate、generated Engineering Manifest equality、`git diff --check` 与一次完整 `pnpm verify`。Work Package 保持 `OPEN / COMPLETE / PASS`；Runtime/Visual/Accessibility Owner acceptance 仍是后续明确 external decision。

### 1.2B.0J `PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_REWORK`

本 Amendment 响应 Owner 对 §1.2B.0I 已实现结果的明确否定：实际 Wide Sidebar 展开/收起仍由多个 Submenu Height Transition、Sider Width Transition 与主内容响应式重排同时驱动，无法形成连续、流畅的切换；Solid Material 下 Hover 与 Selected Surface 又投影到同一 Panel，硬 Route Dot 和整块 Bottom Dock Panel 也没有形成协调、规整的方向 2 视觉层级。Architecture-only Landing 先冻结后续原子源码修正所需的唯一合同；随后授权的源码 Landing 已在该合同内完成 Theme-tinted Selected Surface、Soft Aura、双静态 Menu 原子切换、Main Content compositor bridge、连续 Bottom Dock 与 Wide Appearance 四列投影，不新增 Token、Dependency、Generated Output 或 Runtime Capability。

```text
AMENDMENT=PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_ADMISSION_AMENDMENT
AMENDMENT_KIND=ARCHITECTURE_ONLY_SERIAL_OWNER_DIRECTED_NAVIGATION_VISUAL_AND_REFLOW_CORRECTION_ADMISSION
AMENDMENT_STATUS=FROZEN
NORMATIVE_WRITE_AUTHORITY=ARCHITECTURE.md
SOURCE_IMPLEMENTATION_IN_THIS_AMENDMENT=PROHIBITED
ACTIVATION_EFFECT=CANONICAL_WORK_PACKAGE_ADMISSION_ONLY
SOURCE_IMPLEMENTATION_AUTHORITY=PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_REWORK_ONLY_UNDER_THIS_FROZEN_CONTRACT
WORK_PACKAGE=PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_REWORK
WORK_PACKAGE_CLASSIFICATION=BOUNDED_ADMIN_NAVIGATION_VISUAL_STATE_COLLAPSE_REFLOW_AND_APPEARANCE_GRID_CORRECTION
PARENT_WORK_PACKAGE=PAVP_ARCHITECTURE_ADMIN_CONSOLE
STATUS=OPEN
REPOSITORY_IMPLEMENTATION=COMPLETE
STATIC_VERIFICATION=PASS
...
OWNER_REJECTION_CAUSES=HOVER_SELECTED_STATE_COLLISION;HARD_ROUTE_DOT_PRESENTATION;COLLAPSE_REFLOW_JANK;BOTTOM_DOCK_PANEL_PRESENTATION;WIDE_APPEARANCE_GRID_COLUMN_JUMP
OWNER_SOURCE_IMPLEMENTATION_AUTHORIZATION=CONFIRMED
OWNER_DO_NOT_REQUEST_RECONFIRMATION=CONFIRMED
...
#### Current Work 串行接管与 §1.2B.0I 证据保留

```text
PREVIOUS_CURRENT_BOUNDED_WORK_AUTHORITY=PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_ADMISSION_AMENDMENT
PREVIOUS_CURRENT_BOUNDED_WORK=PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_REWORK
PREVIOUS_CURRENT_BOUNDED_WORK_STATUS=OPEN
PREVIOUS_CURRENT_BOUNDED_WORK_REPOSITORY_IMPLEMENTATION=COMPLETE
PREVIOUS_CURRENT_BOUNDED_WORK_STATIC_VERIFICATION=PASS
PREVIOUS_CURRENT_BOUNDED_WORK_OWNER_VISUAL_ACCEPTANCE=REJECTED_FOR_COLLAPSE_REFLOW_SELECTED_STATE_AND_BOTTOM_DOCK_PRESENTATION
PREVIOUS_CURRENT_BOUNDED_WORK_DISPOSITION=PRESERVED_AS_IMPLEMENTED_STATIC_BASELINE_NOT_CURRENT
HISTORICAL_SECTION_1_2B_0I_ADMISSION_TIME_CURRENT_BOUNDED_WORK_AUTHORITY_LITERAL=CURRENT_BOUNDED_WORK_AUTHORITY=PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_ADMISSION_AMENDMENT
HISTORICAL_SECTION_1_2B_0I_ADMISSION_TIME_CURRENT_BOUNDED_WORK_LITERAL=CURRENT_BOUNDED_WORK=PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_REWORK
...
§1.2B.0I 的 `OPEN / COMPLETE / PASS` 继续是已完成 Repository Implementation 与 Canonical Static Gate 的历史事实，不等于 Owner Visual Acceptance，也不得回退为 `NOT_STARTED / NOT_RUN`。两条 Historical Literal 只把 §1.2B.0I 获准成为 Current Work 时的 Authority 与 Work ID 固定为可逆 Probe 输入，不恢复其 Current 状态，也不修改 §1.2B.0I 历史合同。新包只串行接管最终 Navigation Visual State、Wide Collapse Reflow 与 `/appearance` Wide Gallery Column Stability；既有 Route、Drawer、Focus、Scroll、Keyboard、Preference、Storage、Theme Registry 和其他九个页面内容模型保持不变。

#### 方向 2 Selected、Hover 与 Decoration 合同
...
LEVEL_2_ACTIVE_SURFACE_INSET=NAIVE_NATIVE_MENU_ITEM_CONTENT_BEFORE_GEOMETRY
...
LEVEL_2_ACTIVE_SURFACE_RADIUS_AUTHORITY=interaction.radius.panel
LEVEL_2_ACTIVE_SURFACE_BORDER=NONE
LEVEL_2_ACTIVE_SURFACE_SHADOW=NONE
LEVEL_2_ACTIVE_FOREGROUND_AUTHORITY=color.control.primary
LEVEL_2_ACTIVE_LEFT_INDICATOR=PROHIBITED
LEVEL_2_ACTIVE_HOVER_SURFACE=SAME_AS_LEVEL_2_ACTIVE_SURFACE
LEVEL_2_ACTIVE_HOVER_FOREGROUND=SAME_AS_LEVEL_2_ACTIVE_FOREGROUND
LEVEL_2_ACTIVE_PRESSED_SURFACE=SAME_AS_LEVEL_2_ACTIVE_SURFACE
LEVEL_2_ACTIVE_PRESSED_FOREGROUND=SAME_AS_LEVEL_2_ACTIVE_FOREGROUND
NON_SELECTED_PRESSED_SURFACE=EXISTING_NAVIGATION_HOVER_SURFACE
LEVEL_2_HARD_ROUTE_DOT=PROHIBITED
ACTIVE_ROUTE_DOT_DISPOSITION=SUPERSEDED_BY_ONE_TRAILING_SOFT_CONTROL_PRIMARY_AURA
LEVEL_2_ACTIVE_DECORATION_COUNT=1
...
LEVEL_2_ACTIVE_AURA_SIZE_AUTHORITY=calc(var(--ui-space-content-gap) * 2)
...
LEVEL_2_ACTIVE_AURA_POSITION=TRAILING_INSET
LEVEL_2_ACTIVE_AURA_ACCESSIBILITY=ARIA_HIDDEN_DECORATION
LEVEL_2_ACTIVE_AURA_POINTER_EVENTS=NONE
COLLAPSED_ROOT_ACTIVE_SURFACE=COMPACT_CENTERED_THEME_TINTED_OVERLAY_STATE_PROJECTION
COLLAPSED_ROOT_ACTIVE_SURFACE_COLOR_FORMULA=SAME_AS_LEVEL_2_ACTIVE_SURFACE_COLOR_FORMULA
COLLAPSED_ROOT_ACTIVE_LEFT_INDICATOR=PROHIBITED
COLLAPSED_ROOT_HARD_DOT=PROHIBITED
COLLAPSED_ROOT_ACTIVE_DECORATION=ONE_COMPACT_SOFT_CONTROL_PRIMARY_AURA
COLLAPSED_DROPDOWN_ACTIVE_SURFACE=SAME_AS_LEVEL_2_ACTIVE_SURFACE
COLLAPSED_DROPDOWN_ACTIVE_HOVER_SURFACE=SAME_AS_LEVEL_2_ACTIVE_SURFACE
COLLAPSED_DROPDOWN_HARD_DOT=PROHIBITED
ACTIVE_ROUTE_SEMANTIC_AUTHORITY=aria-current
ACTIVE_DECORATION_SEMANTIC_MEANING=NONE
FOCUS_VISUAL_AUTHORITY=color.focus.ring
SELECTED_BORDER_AS_FOCUS_SUBSTITUTE=PROHIBITED
NARROW_DRAWER_VISUAL_AND_BEHAVIOR_CHANGE=NONE
```

非 Selected Hover 精确保留既有低对比 Surface，不改颜色、几何或 Motion；Selected、Selected Hover 与 Selected Pressed 始终保持同一个主题雾面 Inset Surface，使 Interaction State 不再因 Hover 而退回 Neutral Panel。Expanded Root 继续只提升 Foreground，不允许左侧高亮条或整行 Fill。旧 4px Hard Dot 与 collapsed/dropdown hard pseudo-dot 全部退役；唯一 Aura 只作为末端低强度装饰，`aria-current` 和现有 Focus Ring 分别继续拥有 Route 语义与 Keyboard Focus 语义。

#### Theme Tint、Material 与降级合同

```text
SELECTED_STATE_PROJECTION_CLASS=UI_INTERNAL_ADMIN_INTERACTION_STATE_NOT_MATERIAL_ROLE
SELECTED_SURFACE_THEME_COLOR_INPUT=admin.navigation.selected
SELECTED_SURFACE_MATERIAL_BASE=material.overlay.background
SELECTED_TINT_STRENGTH=12%
SELECTED_AURA_STRENGTH=24%
...
ADAPTIVE_MATERIAL_SELECTED_SURFACE=THEME_TINTED_EXISTING_OVERLAY
ADAPTIVE_MATERIAL_SELECTED_AURA=STATIC_RADIAL_THEME_TINT_FALLOFF
REDUCED_MATERIAL_SELECTED_SURFACE=FLAT_THEME_TINTED_EXISTING_OVERLAY
REDUCED_MATERIAL_SELECTED_AURA=HIDDEN
REDUCED_MATERIAL_FILTER=NONE
REDUCED_MATERIAL_BACKDROP_FILTER=NONE
SOLID_MATERIAL_SELECTED_SURFACE=FLAT_OPAQUE_THEME_TINTED_PANEL
SOLID_MATERIAL_SELECTED_AURA=HIDDEN
SOLID_MATERIAL_FILTER=NONE
SOLID_MATERIAL_BACKDROP_FILTER=NONE
PREFERS_REDUCED_TRANSPARENCY_SELECTED_SURFACE=FLAT_THEME_TINTED_SURFACE
PREFERS_REDUCED_TRANSPARENCY_SELECTED_AURA=HIDDEN
PREFERS_REDUCED_TRANSPARENCY_FILTER=NONE
PREFERS_REDUCED_TRANSPARENCY_BACKDROP_FILTER=NONE
...
FORCED_COLORS_FILTER=NONE
FORCED_COLORS_BACKDROP_FILTER=NONE
FORCED_COLORS_FOCUS=EXISTING_TOKEN_OWNED_OUTLINE
NEW_PUBLIC_VISUAL_TOKEN=NONE
NEW_UI_INTERNAL_VISUAL_TOKEN=NONE
NEW_MATERIAL_ROLE=NONE
NEW_MATERIAL_AUTHORITY=NONE
BUILT_IN_THEME_CHANGE=NONE
CUSTOM_THEME_CONTRACT_CHANGE=NONE
```

`12%` Selected Wash 与 `24%` Aura 是该唯一 Admin Navigation State 的 Architecture-owned Private Projection Constant，不是第二 Theme、Public Role、Material Role 或 Token Authority；实际颜色仍只来自 `admin.navigation.selected` 和既有 Material Overlay。Aura 只允许通过静态 Radial Theme Tint Falloff 柔化自身 Decoration，不允许 `filter`、`backdrop-filter`、Glass-on-glass 或 Filter Animation。Solid、Reduced、Reduced Transparency 与 Forced Colors 必须按上表降级为稳定平面结果。

#### Naive State Projection 与 Bottom Utility Dock

```text
NAIVE_MENU_COLOR=EXISTING_MATERIAL_CHROME
NAIVE_MENU_ITEM_COLOR_HOVER=EXISTING_--ui-admin-navigation-hover_UNCHANGED
NAIVE_MENU_ITEM_COLOR_ACTIVE=LEVEL_2_ACTIVE_SURFACE_COLOR_FORMULA
NAIVE_MENU_ITEM_COLOR_ACTIVE_HOVER=LEVEL_2_ACTIVE_SURFACE_COLOR_FORMULA
NAIVE_MENU_ITEM_COLOR_ACTIVE_COLLAPSED=LEVEL_2_ACTIVE_SURFACE_COLOR_FORMULA
NAIVE_DROPDOWN_OPTION_COLOR_HOVER=EXISTING_--ui-admin-navigation-hover_UNCHANGED
NAIVE_DROPDOWN_OPTION_COLOR_ACTIVE=LEVEL_2_ACTIVE_SURFACE_COLOR_FORMULA
NAIVE_EXPANDED_ROOT_CHILD_ACTIVE_FOREGROUND=color.control.primary
NAIVE_EXPANDED_ROOT_CHILD_ACTIVE_SURFACE=NONE
NAIVE_THEME_AND_CSSR_OWNS=selected inset surface;background-color transition;final Sider and Menu geometry
PAVP_NAMESPACED_SELECTOR_OWNS=selected pressed retention;collapsed and dropdown aura;forced-color and flat-material fallback;named switch transition suppression
APPLICATION_OR_PAGE_NAIVE_SELECTOR=PROHIBITED
VENDOR_DOM_QUERY_OR_PATCH=PROHIBITED
COLLAPSE_CONTROL_PLACEMENT=BOTTOM_UTILITY_DOCK
BOTTOM_DOCK_STANDALONE_PANEL=PROHIBITED
BOTTOM_DOCK_SURFACE=SAME_AS_PERSISTENT_SIDER_CHROME
BOTTOM_DOCK_BORDER=NONE
BOTTOM_DOCK_SHADOW=NONE
...
BOTTOM_DOCK_EXPANDED_LABEL_ALIGNMENT=NAVIGATION_LABEL_COLUMN
BOTTOM_DOCK_COLLAPSED_LABEL=NOT_RENDERED_IN_STABLE_STATE
BOTTOM_DOCK_COLLAPSED_ICON_ALIGNMENT=SAME_NAVIGATION_ICON_AXIS
...
Bottom Utility Dock 继续位于 Persistent Sidebar 底部，但不得再呈现为独立 Material Panel、Card、Outline 或 Shadow。默认 Surface 与 Sider Chrome 连续，只保留一条内嵌 Hairline；Expanded Label 与菜单 Label Column 对齐，Collapsed Icon 与菜单 Icon Axis 对齐。Dock Foreground 只负责视觉桥接且必须 `pointer-events: none`，真实 Button Border Box 独占 Hit Target，透明溢出内容不得扩大可点击区域。Lazy Adapter 未就绪、GSAP 接管中、正常完成、失败回退和 Disposal 后都必须保持同一行与同一 Icon Axis，禁止 CSS/GSAP Handoff 改变 Grid Column、Row、Hit Target 或 Dock 自身 Clip Geometry。

#### Wide Collapse Reflow 与 GSAP 合成层桥接

```text
GSAP_GLOBAL_STATUS=DEFERRED
GSAP_INSTANCE_ADMISSION_COUNT=1
GSAP_INSTANCE_ADMISSION_OWNER=PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_REWORK_ONLY
PREVIOUS_GSAP_INSTANCE_ADMISSION_OWNER=PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_REWORK_HISTORICAL_IMPLEMENTED_BASELINE
GSAP_DEPENDENCY_COORDINATE=gsap@3.15.0
...
PERSISTENT_SIDER_SWITCH_OVERFLOW_PURPOSE=ALLOW_OUTGOING_FIXED_NAVIGATION_PLANE_COMPOSITOR_EXIT
...
NAVIGATION_MENU_PRESENTATION_MODE_SWITCH=ONE_ATOMIC_PAVP_OWNED_COMMIT_WITHOUT_PER_SUBMENU_ENTER_OR_LEAVE
FULL_COLLAPSE_VISUAL_BRIDGE=GSAP_COMPOSITOR_ONLY_OPACITY_VISIBILITY_TRANSLATEX_AND_DECORATION_SCALE_ON_EXPLICIT_PAVP_OWNED_TARGETS
...
FULL_COLLAPSE_DURATION_AUTHORITY=interaction.motion.duration
FULL_COLLAPSE_EASING_AUTHORITY=interaction.motion.easing
...
REDUCED_COLLAPSE_DURATION_AUTHORITY=calc(interaction.motion.duration / 2)
NONE_COLLAPSE_VISUAL_BRIDGE=NONE_IMMEDIATE_ATOMIC_FINAL_STATE
GSAP_SURFACE_BACKGROUND_BORDER_FILTER_BACKDROP_FILTER_OWNERSHIP=PROHIBITED
GSAP_VENDOR_DOM_OWNERSHIP=NONE
GSAP_INPUT=explicit PAVP-owned HTMLElement references only
GSAP_DOM_QUERY=PROHIBITED
GSAP_VENDOR_DOM_PATCH=PROHIBITED
FINAL_STABLE_PAVP_OWNED_GEOMETRY_TRANSFORM=none
TEMPORARY_PERSISTENT_GEOMETRY_TRANSFORM_EXCEPTION=FULL_WIDE_COLLAPSE_MAIN_CONTENT_TRANSLATEX_BRIDGE_ONLY
PAVP_MOTION_GEOMETRY_STABILITY_REPAIR_SUPERSESSION=TEMPORARY_COMPOSITOR_BRIDGE_ONLY_WITH_IDENTICAL_FINAL_GEOMETRY_IN_FULL_REDUCED_AND_NONE
```

Wide Collapse 不再把 Sider `max-width` 当作 200ms Layout Animation，也不得同时触发每个已展开 Submenu 的 Height Transition。每次输入只允许一次 Final Layout Commit；Full 可在显式 PAVP-owned Navigation Foreground、Bottom Dock 和 Main Content Plane 上用 GSAP `opacity / visibility / translateX` 与 Decoration-only `scale` 桥接提交前后视觉，Layout Read 只允许发生在一次提交前后且 Tween 期间为零。Stable Sider Content Overflow 必须回到 `hidden`；仅在 Named Switch 生命周期内允许 PAVP Shell Local State Custom Property 临时投影为 `visible`，使固定宽度 Outgoing Plane 能完成 Compositor Exit，同时全部视觉溢出 Foreground 不得扩张 Hit Target。Reduced 只保留 100ms Opacity，None 立即完成；三个档位的最终 Width、Route、Expanded Keys、Focus、Scroll、Reading Order、Accessible Name 与 Hit Target 必须同态。

#### `/appearance` Wide Gallery Stability
...
在 Wide Profile 下，Sidebar 展开、切换中与收起后的 Theme Gallery 都必须精确保持四列，禁止 `auto-fit` 在一次 Collapse 中把十四张 Card 从四列跳成五列。Regular 与 Narrow 仍使用既有响应式行为；主题身份、顺序、选择、Mutation、Preview 和 Appearance 六轴合同均不改变。

#### Motion Lifecycle、Reversal 与 Accessibility
...
GSAP_PERMANENT_WILL_CHANGE=PROHIBITED
GSAP_TIMER_OR_RAF_OWNERSHIP=NONE
GSAP_LAZY_LOAD_FAILURE_POLICY=HANDLED_REJECTION_AND_STABLE_CSS_FINAL_STATE_WITHOUT_RETRY_LOOP
GSAP_LAZY_LOAD_FAILURE_UNHANDLED_REJECTION=PROHIBITED
GSAP_LAZY_LOAD_FAILURE_NAVIGATION_BLOCKING=PROHIBITED
ACCESSIBLE_NAME_UPDATE=IMMEDIATE_WITH_SEMANTIC_STATE
FOCUS_TRANSFER_BY_MOTION=PROHIBITED
READING_ORDER_CHANGE_BY_MOTION=PROHIBITED
ARIA_CURRENT_AUTHORITY=PRESERVED
NATIVE_SCROLL=PRESERVED
MOTION_RESULT_PARITY=REQUIRED
```

快速 Collapse → Expand、Expand → Collapse 与 Route A → B → A 必须反向或按剩余距离续接，不能从中间状态重新播放完整 200ms。Collapse 与 Route 必须拥有独立 Handoff Marker；Aggregate Ready 只表达任一 Context 正在运行，不得让 Route 临时禁用 Dock Stable CSS，也不得让 Collapse 临时禁用 Aura Stable CSS。正常完成与所有异常路径都必须清除 Inline Style、Context、Timeline、Aggregate Ready、独立 Handoff Attribute 和 Listener，使 CSS Stable State 真正重新接管。Document Hidden 时不得重新创建 Context 或 Timeline；Lazy Import/Controller Construction Failure 必须显式处理 Rejection 并保持可操作的 CSS Final State。

#### 两阶段允许路径

Architecture-only Stage 精确只允许：
...
本 Stage 禁止 UI、Application、Design Token、Generated Output、Dependency、Lockfile、Project Configuration、Bundle、Runtime、Workflow、Test、Browser、Screenshot、Trace 与 Evidence Artifact 修改。
...
Owning Checker 必须保持 §1.2B.0H 与 §1.2B.0I 的 `FROZEN / OPEN / COMPLETE / PASS` 历史证据，并把全部 13 份 Current Work Mirror 保持为本 Amendment 与新包的 `FROZEN / OPEN / COMPLETE / PASS`。原 Architecture-only Landing 的精确 12 个可逆 Admission Probe 继续保留，并在源码 Landing 后改为阻止状态回退及合同漂移：

1. Current Work 留在 §1.2B.0I 旧包。
2. Current Work 改为 Unauthorized ID。
3. 新 Amendment 从 `FROZEN` 回退为 `DRAFT`。
4. 源码 Landing 后把 Repository Implementation 回退为 `NOT_STARTED`。
5. 源码 Landing 后把 Static Verification 回退为 `NOT_RUN`。
6. 把 Non-selected Hover 从 `UNCHANGED` 改走。
7. 把 Selected Surface 精确 `12%` Theme Tint Formula 改走。
8. 重新允许 Hard Route Dot。
9. 重新允许 Per-frame Sider Width Tween。
10. 重新允许 Per-submenu Forced-layout Transition。
11. 允许 Bottom Dock 在 CSS/GSAP Handoff 改变 Geometry。
12. 把 `/appearance` Wide Column Count 从 `4` 改为 `5`。

独立源码 Landing 已按允许路径原子实现方向 2 Theme-tinted Selected Surface、Soft Aura、双静态菜单前景、Named-switch Sider Transition Suppression、GSAP 合成层桥接、Bottom Dock 连续 Chrome 与 `/appearance` Wide 四列稳定性，并把新包推进为 `OPEN / COMPLETE / PASS`。Owning Checker 在保留旧导航与旧 GSAP Source Invariant/Probe 的同时，新增精确 8 项 Source Invariant 与 8 个只修改内存 Source 的可逆 Source Probe，分别保护 Selected Projection、Aura、Material Fallback、Bottom Dock Handoff、Atomic Layout Commit、Compositor Ownership、Motion Lifecycle 与 Wide Gallery 四列。Repository Static Completion 不恢复 Runtime、Visual、Accessibility 或 Release Acceptance；这些仍由后续 Owner External Decision 独立决定。

### 1.2B.0K `PAVP_ADMIN_NAVIGATION_VISIBLE_HOVER_AND_UNIFIED_SELECTED_REVEAL_REWORK`

本 Amendment 响应 Owner 对 §1.2B.0J 已实现视觉结果的后续明确否定：Solid Material 下 `admin.navigation.hover` 与 Persistent Sidebar Chrome 仍可投影为同一 Panel，非 Selected Hover 缺少可感知反馈；Selected Surface 虽已具有主题色投影，但唯一 GSAP Route Decoration 在 Solid 与 Reduced Material 下被隐藏，点击后无法看见统一 Inset 高亮以动画方式渲染。Owner 已明确选择最佳方案。Architecture-only Landing 只串行冻结一个完整 Inset Selected Reveal Plane、可见且弱于 Selected 的 Hover、以及统一 Full / Reduced / None 生命周期合同；本任务不授权源码实施，也不修改 §1.2B.0J 历史合同。

```text
AMENDMENT=PAVP_ADMIN_NAVIGATION_VISIBLE_HOVER_AND_UNIFIED_SELECTED_REVEAL_ADMISSION_AMENDMENT
...
WORK_PACKAGE=PAVP_ADMIN_NAVIGATION_VISIBLE_HOVER_AND_UNIFIED_SELECTED_REVEAL_REWORK
WORK_PACKAGE_CLASSIFICATION=BOUNDED_ADMIN_NAVIGATION_HOVER_VISIBILITY_SELECTED_SURFACE_AND_ROUTE_REVEAL_CORRECTION
PARENT_WORK_PACKAGE=PAVP_ARCHITECTURE_ADMIN_CONSOLE
STATUS=OPEN
...
OWNER_DO_NOT_REQUEST_RECONFIRMATION=NOT_APPLICABLE_UNTIL_SOURCE_IMPLEMENTATION_IS_SEPARATELY_AUTHORIZED
...
#### Current Work 串行接管与 §1.2B.0J 证据保留

```text
PREVIOUS_CURRENT_BOUNDED_WORK_AUTHORITY=PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_ADMISSION_AMENDMENT
PREVIOUS_CURRENT_BOUNDED_WORK=PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_REWORK
PREVIOUS_CURRENT_BOUNDED_WORK_STATUS=OPEN
PREVIOUS_CURRENT_BOUNDED_WORK_REPOSITORY_IMPLEMENTATION=COMPLETE
PREVIOUS_CURRENT_BOUNDED_WORK_STATIC_VERIFICATION=PASS
PREVIOUS_CURRENT_BOUNDED_WORK_OWNER_VISUAL_ACCEPTANCE=REJECTED_FOR_HOVER_AND_SELECTED_REVEAL_VISIBILITY
PREVIOUS_CURRENT_BOUNDED_WORK_DISPOSITION=PRESERVED_AS_IMPLEMENTED_STATIC_BASELINE_NOT_CURRENT
HISTORICAL_SECTION_1_2B_0J_ADMISSION_TIME_CURRENT_BOUNDED_WORK_AUTHORITY_LITERAL=CURRENT_BOUNDED_WORK_AUTHORITY=PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_ADMISSION_AMENDMENT
HISTORICAL_SECTION_1_2B_0J_ADMISSION_TIME_CURRENT_BOUNDED_WORK_LITERAL=CURRENT_BOUNDED_WORK=PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_REWORK
WORK_PACKAGE_RELATION=SERIAL_OWNER_DIRECTED_NAVIGATION_INTERACTION_CORRECTION
PARALLEL_NAVIGATION_IMPLEMENTATION=PROHIBITED
SOURCE_OVERLAP_DISPOSITION=NEW_WORK_PACKAGE_OWNS_ONLY_THE_FINAL_NAVIGATION_HOVER_SELECTED_SURFACE_AND_ROUTE_REVEAL_DIFF
PREVIOUS_IMPLEMENTATION_ROLLBACK=PROHIBITED
```

§1.2B.0J 的 `OPEN / COMPLETE / PASS` 继续是已完成 Repository Implementation 与 Canonical Static Gate 的历史事实，不得回退为 `NOT_STARTED / NOT_RUN`。本包只串行接管 Hover 可见性、Selected Tint 强度、尾端 Aura 退役、Solid / Reduced Material Reveal 可见性与 Route Reveal Handoff。§1.2B.0J 已冻结并实现的双静态 Menu、Wide Collapse 原子 Reflow、Bottom Utility Dock、Wide Appearance 四列、Route、Drawer、Focus、Scroll、Keyboard、Preference、Storage、Theme Registry、Geometry 与其他九个页面内容模型全部保持不变。

#### 方向 2、Hover 与 Selected Surface 合同

```text
NAVIGATION_VISUAL_DIRECTION=PRESERVED_OWNER_SELECTED_DIRECTION_2_ORDERLY_INSET_SELECTION
EXPANDED_ROOT_ACTIVE_PRESENTATION=FOREGROUND_ONLY_AT_REST
EXPANDED_ROOT_ACTIVE_SURFACE=NONE_AT_REST
EXPANDED_ROOT_LEFT_ACTIVE_INDICATOR=PROHIBITED
EXPANDED_ROOT_ACTIVE_OUTLINE=PROHIBITED
EXPANDED_ROOT_ACTIVE_BADGE=PROHIBITED
...
NAVIGATION_NON_SELECTED_HOVER_BORDER=NONE
NAVIGATION_NON_SELECTED_HOVER_SHADOW=NONE
NON_SELECTED_PRESSED_SURFACE=SAME_AS_NON_SELECTED_HOVER_SURFACE
LEVEL_2_ACTIVE_SURFACE=INSET_THEME_TINTED_OVERLAY_STATE_PROJECTION
LEVEL_2_ACTIVE_SURFACE_INSET=NAIVE_NATIVE_MENU_ITEM_CONTENT_BEFORE_GEOMETRY
...
SELECTED_HOVER_AND_PRESSED_FOREGROUND=SAME_AS_SELECTED_FOREGROUND
COLLAPSED_ROOT_ACTIVE_SURFACE=SAME_16_PERCENT_THEME_TINT_PROJECTION
COLLAPSED_ROOT_ACTIVE_LEFT_INDICATOR=PROHIBITED
COLLAPSED_DROPDOWN_ACTIVE_SURFACE=SAME_16_PERCENT_THEME_TINT_PROJECTION
COLLAPSED_DROPDOWN_ACTIVE_HOVER_SURFACE=SAME_AS_SELECTED_SURFACE
TRAILING_SOFT_AURA_DISPOSITION=SUPERSEDED_BY_UNIFIED_INSET_SELECTED_REVEAL_PLANE
...
Hover 与 Selected 精确形成 `6% / 16%` 的两级主题色层级；Hover 可感知但不得接近或覆盖 Selected，Selected、Selected Hover 与 Selected Pressed 始终保持同一稳定 Inset Surface。Expanded Root 在稳定 Active 状态继续只提升 Foreground，不恢复整行 Active Fill；Hover 是独立的瞬时交互反馈。一级与二级菜单都不得恢复左侧高亮条、Hard Dot、Outline、Badge 或额外 Shadow。

#### Unified Inset Selected Reveal 与视觉权威

```text
SELECTED_STATIC_SURFACE_OWNER=NAIVE_THEME_AND_CSSR
SELECTED_STATIC_SURFACE_TRANSITION_PROPERTY=background-color
...
SELECTED_REVEAL_RADIUS_AUTHORITY=interaction.radius.panel
SELECTED_REVEAL_BORDER=NONE
SELECTED_REVEAL_SHADOW=NONE
SELECTED_REVEAL_FILTER=NONE
SELECTED_REVEAL_BACKDROP_FILTER=NONE
SELECTED_REVEAL_POINTER_EVENTS=NONE
SELECTED_REVEAL_ACCESSIBILITY=ARIA_HIDDEN_DECORATION
SELECTED_REVEAL_TRANSIENT_OWNER=EXISTING_SINGLE_GSAP_ROUTE_SELECTION_TIMELINE
SELECTED_REVEAL_FINAL_HANDOFF=IDENTICAL_COLOR_AND_GEOMETRY_FROM_TRANSIENT_REVEAL_TO_NAIVE_STATIC_SURFACE
SELECTED_REVEAL_READY_STATIC_SURFACE_HANDOFF=PAVP_NAMESPACED_CSS_TEMPORARY_SUPPRESSION_ONLY
SELECTED_REVEAL_STABLE_STATE=NAIVE_STATIC_SURFACE_VISIBLE_AND_TRANSIENT_REVEAL_HIDDEN
HOVER_AND_SELECTED_PRIVATE_PROJECTION_CONSTANT_AUTHORITY=SECTION_1_2B_0K_ONLY
HOVER_AND_SELECTED_COLOR_INPUTS=admin.navigation.selected;material.chrome.background;material.overlay.background
NEW_PUBLIC_VISUAL_TOKEN=NONE
NEW_UI_INTERNAL_VISUAL_TOKEN=NONE
NEW_MATERIAL_ROLE=NONE
BUILT_IN_THEME_CHANGE=NONE
...
后续源码实施若获独立授权，必须复用现有 PAVP-owned Route Decoration 元素并把它重定义为完整 Inset Reveal Plane，不得新增第二 Decoration、Timeline、Ready Attribute 或 DOM Query。Named Route Marker 生命周期内，PAVP Namespaced CSS 只可临时抑制 Naive Stable Selected Surface 的可见性；GSAP 只动画同色同几何 Reveal Plane。完成、反向、中断与失败回退时必须原子恢复 Naive Stable Surface 并清理 Reveal Inline State，使 Handoff 不闪烁、不露出 Neutral Panel。`6% / 16%` 只是本节冻结的私有 Admin Navigation State Projection Constant，不构成第二 Token 或 Material Authority；全部颜色输入继续来自既有 Design Token 与 Material Authority。

#### Material 与降级合同

```text
ADAPTIVE_MATERIAL_SELECTED_SURFACE=THEME_TINTED_EXISTING_OVERLAY
ADAPTIVE_MATERIAL_SELECTED_REVEAL=VISIBLE_THEME_TINTED_EXISTING_OVERLAY_DURING_ROUTE_HANDOFF
REDUCED_MATERIAL_SELECTED_SURFACE=FLAT_THEME_TINTED_EXISTING_OVERLAY
...
Solid、Reduced 与 Reduced Transparency 不得再通过 `display:none` 隐藏唯一 Route Reveal Target；这些分支使用不含 Filter、Backdrop Filter 或透明玻璃叠层的平面主题色 Reveal。Adaptive 可继续投影现有 Material Overlay，但 Reveal 自身不取得任何 Blur 或 Filter Authority。Forced Colors 隐藏纯装饰 Reveal，由稳定 Selected Surface、Foreground 与既有 Focus Ring 表达完整语义。

#### 单一 Motion Preference、GSAP 与 Handoff 合同

```text
MOTION_PREFERENCE_AUTHORITY=EXISTING_FULL_REDUCED_NONE_APPEARANCE_STATE_ONLY
GSAP_GLOBAL_STATUS=DEFERRED
GSAP_INSTANCE_ADMISSION_COUNT=1
GSAP_INSTANCE_ADMISSION_OWNER=PAVP_ADMIN_NAVIGATION_VISIBLE_HOVER_AND_UNIFIED_SELECTED_REVEAL_REWORK_ONLY
PREVIOUS_GSAP_INSTANCE_ADMISSION_OWNER=PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_REWORK_HISTORICAL_IMPLEMENTED_BASELINE
GSAP_DEPENDENCY_COORDINATE=gsap@3.15.0
GSAP_DEPENDENCY_CHANGE=NONE
GSAP_DYNAMIC_ROOT_CHANGE=NONE
GSAP_BUNDLE_BUDGET_CHANGE=NONE
...
HOVER_FULL_DURATION_AUTHORITY=interaction.motion.duration
HOVER_REDUCED_DURATION_AUTHORITY=calc(interaction.motion.duration / 2)
HOVER_NONE_TRANSITION=NONE
```

Full 使用既有 `interaction.motion.duration` 与 `interaction.motion.easing`，只允许 Reveal Plane 由 `scale(0.96)`、`opacity: 0` 平滑进入 `scale(1)`、`opacity: 1`；Reduced 使用同一 Duration Authority 的一半且只允许 Opacity / Visibility；None 不得创建 Timeline、Context 或 Marker，必须立即显示 Naive Static Selected Surface。Hover 只归 Naive/CSSR Background-color Transition 所有，并由同一个 Full / Reduced / None Preference 投影；GSAP 不得写 Background、Border、Filter、Backdrop Filter、Width、Height、Inset、Grid、Flex 或其他 Layout Property。Collapse 的既有 Full-only `translateX` 例外保持不变，不扩张到 Route Reveal。

#### Motion Lifecycle、Interruption 与 Accessibility
...
空 Target 集合不得先建立 Context、Timeline 或 Marker；Controller 尚未就绪时必须保留可操作的 CSS Final State，不得缓存旧 Initial State 后延迟 Replay 或把已经绘制的 Final State 倒回起点。快速 Route A → B → C 必须按剩余属性距离缩短持续时间；A → B → A 必须在可逆时反向。每条正常、空目标、Preference Change、Hidden、Lazy Failure、Interruption、Unmount 与 Disposal 路径都必须清理 Inline Style、Context、Timeline 和 Ready Attribute。Full、Reduced 与 None 的 Route、Focus、Scroll、Reading Order、Accessible Name、Hit Target 与最终视觉结果必须同态。
...
后续源码实施必须获得独立 Owner 确认，并只允许在真实需要时修改：
...
Owning Checker 必须保持 §1.2B.0H、§1.2B.0I 与 §1.2B.0J 的全部历史状态证据，并把全部 13 份 Current Work Mirror 精确切换为本 Amendment 与新包的 `FROZEN / OPEN / NOT_STARTED / NOT_RUN`。Architecture-only Gate 至少必须使用只修改内存 Architecture Source、目标失败后完整恢复且零落盘 Artifact 的可逆 Probe 保护：Current Work 未切换或改为 Unauthorized ID；Amendment 回退为 `DRAFT`；Repository Implementation 或 Static Verification 被提前提升；Hover `6%`、Selected `16%`、方向 2、无左条或完整 Inset Reveal Plane 漂移；Solid Reveal 重新允许 `display:none`；Full / Reduced / None 属性白名单漂移；GSAP 获得 Background、Filter 或 Layout Ownership；空 Target 或 Lazy Replay 合同被删除；Architecture-only Allowed Path 扩张到源码或 Token。

本 Architecture-only Landing 只准入 0K 并建立 Current Work Authority，不证明任何源码、Static、Runtime、Visual、Accessibility 或 Release Completion。后续若获得独立 Owner 源码授权，Repository Implementation 与 Static Verification 必须在允许路径的原子源码 Landing 及完整 Canonical Static Gate 后才能从 `NOT_STARTED / NOT_RUN` 推进；Owner Runtime、Visual 与 Accessibility Acceptance 继续是外部明确决定。

### 1.2B.0L `PAVP_ADMIN_NAVIGATION_NATIVE_NAIVE_SIMPLIFICATION`

本 Amendment 响应 Owner 对已提交复杂导航动画系统的最终否定，并曾串行取代 §1.2B.0K。它现在是 `PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS` 的已验收直接前序和结构基线，不再是 Current Bounded Work。§1.2B.0I、§1.2B.0J 与 §1.2B.0K 的冻结状态和历史测量只保留为证据，不再构成活动源码、依赖、动态根、预算或 Handoff 要求；本节的 `ACCEPTED / COMPLETE / PASS` 与精确提交证据保持不变。

```text
AMENDMENT=PAVP_ADMIN_NAVIGATION_NATIVE_NAIVE_SIMPLIFICATION_ADMISSION_AMENDMENT
AMENDMENT_KIND=OWNER_DIRECTED_SUPERSEDING_ADMIN_NAVIGATION_CORRECTIVE_ADMISSION
AMENDMENT_STATUS=FROZEN
WORK_PACKAGE=PAVP_ADMIN_NAVIGATION_NATIVE_NAIVE_SIMPLIFICATION
...
OWNER_ACCEPTANCE_STATEMENT=没问题 通过
OWNER_RUNTIME_ACCEPTANCE=PASS
OWNER_VISUAL_ACCEPTANCE=PASS
...
PREVIOUS_CURRENT_WORK=PAVP_ADMIN_NAVIGATION_VISIBLE_HOVER_AND_UNIFIED_SELECTED_REVEAL_REWORK
...
REJECTION_REASONS=UNNECESSARY_COMPLEXITY;TEXT_BLEED;LAYOUT_OVERLAP;VISUAL_JANK;INCONSISTENT_ALIGNMENT;WORSE_THAN_NATIVE_NAIVE_UI
NEXT_CANONICAL_WORK_PACKAGE=NONE
NEXT_CANONICAL_IMPLEMENTATION_WORK_PACKAGE=NONE
SUCCESSOR_PACKAGE_AUTHORIZATION=NONE
```
...
OVERFLOW_VISIBLE_ANIMATION_STATE=PROHIBITED
FAKE_SIDER_COVER_SURFACE=PROHIBITED
...
WIDE_DEFAULT_NAVIGATION=EXPANDED
REGULAR_NAVIGATION=PERMANENTLY_COLLAPSED
NARROW_DRAWER_CHANGE=NONE
WIDE_APPEARANCE_GALLERY_COLUMN_COUNT=4
APPEARANCE_REFLOW_CHANGE=NONE
```

必须保留 Root-font Rem-to-pixel Bridge、Font Scale Invalidation、Profile Recompute、Controlled Expanded Keys、Current-route No-op、Different-route Single Emit、Menu/Dropdown Pointer Guard、Enter/Space、Dropdown Keyboard、`aria-current`、Focus Ring、`#pavp-overlay-root`、Main Content 单一 Block Scroll Owner、Route、Router、Appearance、Storage、Theme、Material，以及 `UiAdminShell` Public Props、Emit 与 Default Slot。安装版 Naive Trigger 是 Click-only `div`，所以 Sider 保持 `show-trigger=false`；现有 Top Application Header 的 Final Trailing Action 通过私有 `NButton + NIcon + NTooltip` 补足 Accessible Name、Keyboard 与产品级 Tooltip 合同，不恢复原生 Header `button` 或浏览器 `title`。Owner 已确认当前原生 Sider/Menu 折叠 Motion 的视觉观察通过，但该观察只覆盖 Motion，不构成新 Header Placement、Package 或整体 Console 的 Runtime、Visual、Accessibility、Product Experience、Release 或 Production Acceptance。被拒绝的 Sidebar Bottom-left Control 必须完整移除；现有 Top Application Header 的 Final Trailing Action 是唯一 Wide Sidebar Collapse Control Owner，Settings Entry 仍未启动。

Owner 接受现有 Header Final Trailing Action 位置与 Naive 原生 Sider 折叠流畅度；后续检查发现 Collapsed Rail Root Submenu 的 `dropdownProps.trigger='click'` 覆盖了安装版 `NSubmenu` 原生 Hover Trigger，并使普通 Pointer Hover 无法直接进入实际 Submenu Popup。该窄修正恢复安装版 Naive `hover`、`right-start`、默认 enter/leave delay 与 `keepAliveOnHover` 生命周期；Pointer Click 不再是揭示 Popup 的前置条件。Collapsed Root 仍通过公开 `NMenu.nodeProps` 获得 Tab、Enter 与 Space，键盘激活只在真实 `event.currentTarget` 上派发可冒泡的 `mouseenter` Trigger Event，不查询 Vendor DOM、不增加 Global Listener、Timer、Popup State 或 Focus System；Naive Dropdown 继续拥有 Arrow、Enter 与 Escape，Escape 关闭后 Focus 留在 Root Trigger。

```text
COLLAPSED_ROOT_SUBMENU_POINTER_TRIGGER=NAIVE_NATIVE_HOVER
COLLAPSED_ROOT_SUBMENU_POINTER_CLICK_REQUIRED=NO
COLLAPSED_ROOT_SUBMENU_HOVER_CORRIDOR=NAIVE_POPOVER_KEEP_ALIVE_ON_HOVER
COLLAPSED_ROOT_SUBMENU_POPUP_PLACEMENT=NAIVE_VERTICAL_ROOT_RIGHT_START
COLLAPSED_ROOT_SUBMENU_POPUP_TARGET=#pavp-overlay-root
COLLAPSED_ROOT_SUBMENU_KEYBOARD_OPEN=ENTER_AND_SPACE_EVENT_LOCAL_PUBLIC_NODE_PROPS
COLLAPSED_ROOT_SUBMENU_KEYBOARD_NAVIGATION=NAIVE_DROPDOWN_NATIVE
COLLAPSED_ROOT_SUBMENU_ESCAPE=NAIVE_DROPDOWN_NATIVE_TRIGGER_FOCUS_PRESERVED
COLLAPSED_ROOT_SUBMENU_SEPARATE_TOOLTIP=PROHIBITED
COLLAPSED_RAIL_STATE_SURFACE_COUNT=1
COLLAPSED_POPUP_PANEL_SURFACE_COUNT=1
COLLAPSED_POPUP_PANEL_BORDER_COUNT=1
COLLAPSED_POPUP_PANEL_SHADOW_COUNT=1
DUPLICATE_TOOLTIP_BORDER_OUTLINE_SHADOW_OR_STATE_STACKING=PROHIBITED
...
HEADER_ROOT_SUBMENU_CONTROL_PLACEMENT=EXISTING_TOP_APPLICATION_HEADER_TRAILING_BEFORE_SIDEBAR_COLLAPSE
HEADER_ROOT_SUBMENU_CONTROL_STATE_AUTHORITY=expandedNavigationGroupKeys_ONLY
HEADER_ROOT_SUBMENU_CONTROL_EXPANDED_LABEL=折叠全部菜单
HEADER_ROOT_SUBMENU_CONTROL_PARTIAL_OR_COLLAPSED_LABEL=展开全部菜单
...
#### 原生 Hover、Selected Surface 与 Motion
...
FOCUS_VISUAL_AUTHORITY=color.focus.ring
POINTER_HOVER_FOCUS_RING=PROHIBITED
POPUP_PANEL_SURFACE_OWNER=MENU_DROPDOWN_PEER_THEME
POPUP_PANEL_BORDER_OWNER=PAVP_ADMIN_NAVIGATION_DROPDOWN_NAMESPACE
POPUP_PANEL_SHADOW_OWNER=MENU_DROPDOWN_POPOVER_PEER_THEME
POPUP_OPTION_BORDER_OR_OUTLINE=NONE
```

Full Motion 的已验收前序基线只允许既有 `::before` Surface 从 `opacity:0; scale(0.98)` 进入 Hover/Selected 的 `opacity:1; scale(1)`，并只 Transition `background-color`、`opacity` 与 `transform`；Duration/Easing 精确来自 `interaction.motion.duration` 与 `interaction.motion.easing`。旧 Selected 移除 Naive Class/State 时自然退出，新 Selected 同时自然进入，不创建 DOM、Timeline 或共享 Animation State。

Full Motion 同时把 Persistent Menu Hover/Selected Foreground、Submenu Arrow/Height、Collapsed Popup 与两个 Header Navigation Controls 对齐到 `var(--ui-motion-duration)` 和 `var(--ui-motion-easing)`，只保留已准入的 Surface Scale。Reduced Motion 使用 `calc(var(--ui-motion-duration) / 2)` 和同一 Easing；Item/Popup State 只 Transition `background-color`、`color` 与 `opacity`，Motion Effect 使用 `transform:none`，Submenu Height 只保留缩短后的 Naive Native Duration，不增加 Scale、Translation 或其他位置效果。None Motion 对同一完整 Coverage 使用 `transition:none; animation:none`，Surface、Popup 与 Header Motion Effect 使用 `transform:none`，Hover、Selected、Submenu、Popup 与 Header Control 状态立即完成且不得留下旧视觉或 Pointer State；Submenu Arrow 保留 Naive 最终语义方向，但不得 Transition。

精确基线提交 `70cc43995512994b4155df04ddb7896047d8ad3a` 之后出现、但从未提交或获得 Owner Acceptance 的本地 CSS 维护试验全部属于被拒绝的非权威历史。该历史只能解释当前两份未提交 UI Source Residue，不能驱动 Checker、未来 Source Implementation、Dependency、Runtime、Bundle 或 Acceptance：

```text
REJECTED_LOCAL_ADMIN_NAVIGATION_MAINTENANCE_HISTORY=REJECTED_NONAUTHORITATIVE_UNCOMMITTED_LOCAL_IMPLEMENTATION_HISTORY
REJECTED_UNIFORM_SELECTED_SURFACE_SCALE=scale(0.96)_TO_scale(1)
REJECTED_DIRECTIONAL_SELECTED_REVEAL=scaleX(0.86)_scaleY(0.96)_TO_scaleX(1)_scaleY(1)
REJECTED_ONE_SHOT_CSS_BLOOM=PAVP_ADMIN_NAVIGATION_ONE_SHOT_SELECTION_BLOOM_REPAIR
REJECTED_SELECTION_FEEDBACK_PHASE=idle;a;b
REJECTED_ALTERNATING_CSS_KEYFRAMES=pavp-admin-navigation-selection-bloom-a;pavp-admin-navigation-selection-bloom-b
REJECTED_MENU_AFTER_BLOOM=N_MENU_ITEM_CONTENT_AFTER
REJECTED_PERSISTENT_HOVER_SELECTED_GEOMETRY_TRANSFORMS=ALL
REJECTED_EXPERIMENT_ACTIVE_TARGET_AUTHORITY=NONE
REJECTED_EXPERIMENT_SOURCE_INVARIANTS=PROHIBITED
REJECTED_EXPERIMENT_SOURCE_RESIDUE_DISPOSITION=REMOVE_ONLY_IN_LATER_EXPLICIT_SOURCE_IMPLEMENTATION_TASK
```

Route Entry/Leave Motion 明确不属于本窄修正：稳定且无 Key 的单一 Route Content Host、唯一 RouterView、Router Focus/Scroll Lifecycle 与完整 PAVP-RUNTIME-005 合同保持不变；不得增加 Route Transition、Route Animation、Route-level `v-if`/`v-show`、替代 Wrapper 或 Main Transform。Forced Colors 保留清晰 Selected Surface 与独立 Focus Outline；Reduced Transparency 与 Solid 使用可见平面 Surface，不得隐藏 Selected。
...
#### GSAP、Bundle、Engineering Manifest 与静态治理退役
...
NATIVE_PREDECESSOR_BUNDLE_SNAPSHOT=ACCEPTED_IMPLEMENTATION_AT_70cc43995512994b4155df04ddb7896047d8ad3a
...
NATIVE_PREDECESSOR_MOTION_ADAPTER_BUDGET_RECORD=ABSENT_AT_ACCEPTED_IMPLEMENTATION
IMPLEMENTATION_PATH_COUNT=18
IMPLEMENTATION_PATH_INVENTORY=ARCHITECTURE.md;apps/web/src/generated/engineering-manifest.ts;packages/ui/package.json;packages/ui/src/adapters/naive/PavpNaiveConfigProvider.vue;packages/ui/src/adapters/naive/pavp-naive-theme.ts;packages/ui/src/components/UiAdminShell.vue;pnpm-lock.yaml;pnpm-workspace.yaml;project.config.ts;scripts/architecture/check-architecture-admin-console.ts;scripts/architecture/check-boundaries.ts;scripts/architecture/check-ui-public-components.ts;scripts/architecture/generate-engineering-manifest.ts;scripts/verify/check-bundle.ts;scripts/verify/check-project-config.ts;packages/ui/src/adapters/gsap/admin-navigation-motion.ts;packages/ui/src/adapters/naive/naive-icon.ts;packages/ui/src/adapters/naive/naive-tooltip.ts
...
ACCEPTANCE_CLOSURE_REVERSIBLE_PROBE_COUNT=5
```

`packages/ui/src/adapters/gsap/admin-navigation-motion.ts`、GSAP Catalog/Manifest/Lockfile 坐标、Navigation Motion Dynamic Root、`lazyMotionAdapterJavaScriptGzipBytes` 与 Engineering Manifest Motion Budget Record 必须原子删除。Gzip Options、Initial Closure Measurement、CSS Budget、Per-route Budget、Headroom Failure Policy 和其他 Production Bundle Contract 保持不变；Generated Engineering Manifest 只能由 Canonical Generator 更新。

Owning Checker 必须拒绝多于一个 Persistent Sider/Menu、不同 Collapsed Authority、双 Plane、Bridge、Main Content Compensation、Aura/Reveal DOM、GSAP Source/Dependency/Adapter/Root、Native Transition Suppression、非 `6% / 16%` 投影、超出 Full/Reduced/None Allowlist、Expanded Root Active Fill、Collapsed/Dropdown Selected 不可见、Narrow/RUNTIME-003 回退、Wide Appearance 四列回退，以及 Route 17、Kernel 11、Provider `pinia,appearance`、Storage 2 或 Dynamic Root 17 漂移。当前展开状态与 Motion 窄修正额外固定 20 条 Source Invariant，并以恰好 8 个可逆内存 Probe 分别保护 Active Parent 不被持续补回、唯一 Header 全部展开/折叠 Control 的 Placement/State Ownership、Full/Reduced/None Coverage、None Closure、稳定无 Key Route Host、唯一 RouterView、无 Route Motion、PAVP-RUNTIME-005 和 Narrow Drawer 保留。Probe 只修改内存 Source，按目标原因失败并完整恢复，不创建 Test、Fixture 或 Evidence Artifact。

#### 精确写入与验收边界

本包只允许修改 Owner 指令列出的 Admin Navigation、Naive Adapter、GSAP 退役、Package/Catalog/Lockfile、Project Configuration、Bundle/Engineering Manifest 与既有 Owning Checker 文件；禁止修改 `/appearance`、其他页面、App、Console Route Frame、Route Registry、Router Runtime、Runtime Kernel、Storage、Appearance Store/Persistence、Design System Token/Generated Token、Built-in Theme、Vite、Workflow、Public `UiAdminShell` API、Narrow Drawer、Test 或 Browser Infrastructure。

Repository Implementation 与 Canonical Static Verification 在本原子 Landing 通过后为 `COMPLETE / PASS`。当前 Collapsed Hover/Popup 以及展开状态/Motion Correction 不改变该状态，不创建新 Work Package 或 Amendment；Header Trailing Placement、Collapsed Rail Hover Presentation、Native Hover Popup、单一 Rail State Surface、单一 Popup Panel Surface、Active Parent Manual Collapse、Header Root Submenu Control 与 Full/Reduced/None Coverage 按上方合同收口。原实现任务不得代报 Owner Runtime、Visual 或 Accessibility Acceptance，也不授权 Staging、Commit、Push 或 Release；Owner 随后在独立且显式授权的验收与 Git 收口任务中给出上方精确陈述，使本包按既有转移权威收口为 `ACCEPTED / COMPLETE / PASS`，Scoped Runtime 与 Visual Acceptance 为 `PASS`，Accessibility Acceptance 独立保持 `NOT_PERFORMED`。这不恢复 Admin Console 整体 Runtime、Visual、Accessibility 或 Release Acceptance，不构成 Production Release，也不准入 Successor Work。

Owning Checker 在原有全部不变量与 Probe Suite 之外只增加五个可逆 In-memory Acceptance-closure Probes：把 Runtime Acceptance 回退为 `NOT_PERFORMED`；把 Visual Acceptance 回退为 `NOT_PERFORMED`；把 Accessibility Acceptance 错设为 `PASS`；错误恢复整体 Admin Console Acceptance；改变精确 Owner 陈述。五个 Probe 只修改内存文本，必须因各自目标原因失败并完整恢复，不创建 Test、Fixture、Screenshot、Trace 或 Evidence Artifact。

### 1.2B.0M `PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS`

本 Amendment 准入的 `@platform/ui` 私有 Motion for Vue Shared-layout Selected Lens 已按精确发布实施提交 `b6efbb608b309f601217a2765150bd9ec217cf78` 完成精确依赖、私有 Motion Source、Reduced Crossfade、UI Integration、Bundle/Manifest Closure 与 Canonical Static Verification。Owner 给出精确陈述 `效果还可以 可以接受`，因此本包收口为 `ACCEPTED / COMPLETE / PASS`，Scoped Runtime 与 Visual Acceptance 为 `PASS`，Accessibility Acceptance 仍精确为 `NOT_PERFORMED`，并串行转为 §1.2B.0N 新路由转场能力的已验收直接前序，不再是 Current Bounded Work。该收口不恢复 Admin Console 整体 Runtime、Visual、Accessibility、Product Experience 或 Release Acceptance。
...
AMENDMENT_KIND=ARCHITECTURE_ONLY_ADMISSION_AMENDMENT
AMENDMENT_STATUS=FROZEN
SOURCE_IMPLEMENTATION_IN_THIS_AMENDMENT=PROHIBITED
WORK_PACKAGE=PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS
...
OWNER_VISUAL_ACCEPTANCE=PASS
OWNER_ACCESSIBILITY_ACCEPTANCE=NOT_PERFORMED
OWNER_ACCEPTANCE_STATEMENT=效果还可以 可以接受
IMPLEMENTATION_COMMIT=b6efbb608b309f601217a2765150bd9ec217cf78
PUBLICATION_TARGET=origin/main
PUBLICATION_STATUS=COMPLETE
...
```text
PREVIOUS_ADMIN_NAVIGATION_AUTHORITY_INSTANCE=PAVP_ADMIN_NAVIGATION_NATIVE_NAIVE_SIMPLIFICATION
...
PREVIOUS_ADMIN_NAVIGATION_AUTHORITY_IMPLEMENTATION_COMMIT=70cc43995512994b4155df04ddb7896047d8ad3a
SELECTED_STATE_VISUAL_TRANSITION_AUTHORITY_CHANGE=ONLY
...
```text
MOTION_RUNTIME_SOURCE_PATH=packages/ui/src/adapters/motion/admin-navigation-motion-runtime.ts
MOTION_DOM_MAX_PRIVATE_SOURCE_PATH=packages/ui/src/adapters/motion/admin-navigation-dom-max.ts
MOTION_SELECTION_LENS_SOURCE_PATH=packages/ui/src/adapters/motion/AdminNavigationSelectionLens.vue
MOTION_PRIVATE_DIRECTORY=packages/ui/src/adapters/motion/**
MOTION_PUBLIC_PLATFORM_ROOT_EXPORT=PROHIBITED
MOTION_PUBLIC_UI_ADMIN_SHELL_CONTRACT=PROHIBITED
MOTION_APP_WEB_DIRECT_IMPORT=PROHIBITED
MOTION_OUTSIDE_PRIVATE_DIRECTORY_DIRECT_IMPORT=PROHIBITED
MOTION_VENDOR_DOM_QUERY_OR_PATCH=PROHIBITED
MOTION_GEOMETRY_MEASUREMENT=PROHIBITED
MOTION_MUTATION_OBSERVER=PROHIBITED
MOTION_TIMER_REQUEST_ANIMATION_FRAME_OR_FORCED_REFLOW=PROHIBITED
MOTION_ELEMENT_CLONING=PROHIBITED
MOTION_NMENU_OR_ROUTER_VIEW_REMOUNT=PROHIBITED
...
3. 要求该 Union 精确等于 17 个 Registered Lazy Route Roots 加 1 个精确 Motion Feature Root。
4. 每个 Dynamic Import Owner 必须属于 Initial Static Closure。
5. Route Roots 与 Motion Root 均不得拥有进一步 Dynamic Roots。
6. Dynamic Entries 必须等于同一精确 18-root Set。
7. 任何 Dynamic Root 均不得进入 Initial Static Closure。
8. 每个 Route Root 保持既有 One-route/One-JavaScript-chunk Contract。

#### Motion Feature Closure 与预算

```text
MOTION_FEATURE_STATIC_CLOSURE=collectStaticChunkClosure(manifest, MOTION_FEATURE_MANIFEST_KEY)
MOTION_FEATURE_EXCLUSIVE_CLOSURE=
MOTION_FEATURE_STATIC_CLOSURE
minus
INITIAL_STATIC_CLOSURE
...
Initial JavaScript 在精确发布实施提交中的 Final Closure 为 `223308 bytes gzip`；相对实施前 `229376 bytes gzip` Hard Budget 只剩 `6068 bytes gzip`，未满足至少 `8192 bytes gzip` Headroom，因此按冻结公式重定基线到最小可行 8 KiB-aligned `237568 bytes gzip`，最终 Headroom 为 `14260 bytes gzip`：
...
INITIAL_JAVASCRIPT_RETAIN_CONDITION_RESULT_FOR_223308=FALSE
...
该 Replacement 保留 `14260 bytes gzip` Headroom，满足至少 `8192` 且少于 `16384` 的冻结区间；既有 `initial-javascript-gzip` Engineering Manifest Record 已因 Formula 要求从 `229376` 更新为 `237568`。现行 Bundle Gate 同时证明精确 17 个 Route Roots 与 1 个 Motion Feature Root，共 18 个 Dynamic Roots。
...
MOTION_SELECTION_LENS_PROJECTION=PERSISTENT_NAVIGATION_ONLY
...
历史 Architecture-only Landing 的唯一写入路径是 `ARCHITECTURE.md` 与 `scripts/architecture/check-architecture-admin-console.ts`；它没有修改 Dependency、Lockfile、Project Configuration、Engineering Manifest、Bundle Checker、Application/UI Source、Router、Runtime Kernel、Storage、Appearance、Design System、Generated Artifact、Vite 或 Workflow。后续独立授权的 Source Landing 已在本节冻结的允许边界内完成并发布到 `origin/main`；Owner 已对该精确提交完成 Scoped Runtime 与 Visual Acceptance，Accessibility 仍未执行，Production Release 仍为 `NOT_RELEASED`。
...
WORK_PACKAGE=PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY
STATUS=ACCEPTED
REPOSITORY_IMPLEMENTATION=COMPLETE
STATIC_VERIFICATION=PASS
OWNER_RUNTIME_ACCEPTANCE=PASS
...
```text
PREVIOUS_CURRENT_BOUNDED_WORK=PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS
PREVIOUS_CURRENT_BOUNDED_WORK_DISPOSITION=ACCEPTED_DIRECT_PREDECESSOR_NOT_CURRENT
DIRECT_PREDECESSOR_WORK_PACKAGE=PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS
...
DIRECT_PREDECESSOR_OWNER_ACCEPTANCE_STATEMENT=效果还可以 可以接受
...
DIRECT_PREDECESSOR_IMPLEMENTATION_COMMIT=b6efbb608b309f601217a2765150bd9ec217cf78
...
直接前序的 `motion-v@2.4.0`、`@vueuse/core@14.4.0`、唯一 declaration-only `motion-v@2.4.0` Patch、唯一 Motion Dynamic Root、18 个 Total Dynamic Roots、Full Shared Lens、Reduced Native Naive Crossfade、None Immediate Behavior 和现行 Bundle Budgets 均保持不变。该 Scoped Acceptance 不推导 Accessibility Acceptance，不恢复 Admin Console 整体 Runtime、Visual、Accessibility、Product Experience 或 Release Acceptance。
...
MOTION_VUE_REMAINS_SCOPED_TO=PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_ONLY
```

SSGOI、Motion Vue AnimatePresence、Motion Vue Route Layout/Presence、RouterView 外的 Vue Transition、GSAP Route Timeline、Anime.js 和任何新 Route-transition Dependency 都会要求 Route-derived Key、保留真实 Outgoing Route DOM、第二 Scroll Cache/Writer、第二 History Direction Stack、重复可 Focus Route Content 或第二 Router Owner 中的一项或多项，因此与当前单一 Router 和 PAVP-RUNTIME-005 合同冲突。已安装 `motion-v` 仍只服务 Admin Navigation Selection Lens，不获得 Route-content Ownership。

#### PAVP-RUNTIME-005 窄替换合同

```text
PAVP_RUNTIME_005_LIVE_DOM_ROUTE_ANIMATION=PROHIBITED
PAVP_RUNTIME_005_NATIVE_STATIC_SNAPSHOT_TRANSITION=ADMITTED_ONLY_FOR_PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY
...
本 Amendment 只替换旧的 Blanket Snapshot Prohibition：后续实施可以只动画 Browser-created Static Pseudo-element Snapshots。真实 Live Route DOM 仍只有一个 RouterView 和一个稳定、无 Key 的 `.pavp-route-content`；不得添加 Routed-component Key、Vue Transition、AnimatePresence、KeepAlive、Suspense、Route `v-if`/`v-show`、Opacity Concealment、Transform、Real Outgoing DOM 或故意 Blank Frame。Router 继续唯一拥有 URL、History、Guard、Error、Focus 和 Scroll。
...
Stylelint 的 Full Duration 准入只存在于 `apps/web/src/app/router/route-transition/route-transition.css` 的精确 File Override，且只允许 `animation-duration: calc(var(--ui-motion-duration) + var(--ui-motion-duration) / 2)`。全局 `approvedDurationPatterns` 保留原有半时长表达式，所有全局规则及其他 Property/Value Restriction 不变；不将该公式准入其他文件、`transition-duration` 或 `animation` Shorthand，不允许裸时长、乘法、其他 Token 或任意 Calc。该配置修复只解除 Full Pace 的既有 Stylelint 阻塞，不新增配置权威或改变任何 Runtime Behavior。

#### Persistent Divider Authority 与 Snapshot Overflow Containment

当前安装的 `naive-ui@2.45.2` 通过 `NLayoutSider` 内部 `.n-layout-sider__border` 绘制永久分隔线：Absolute Position、Sider End Edge、Vendor `width: 1px` 和 `background-color: var(--n-border-color)`。PAVP 在既有 Private Provider 的 `[data-pavp-admin-navigation='persistent']` namespace 下仅覆盖该元素的 `width: var(--ui-admin-border-width)`；保留 Vendor 定位、Background Strip、DOM、Collapse Motion 和 `Layout.siderBorderColor -> color.border.default` 投影。不将 Vendor 原始裸宽度误称为既有 PAVP Authority。

```text
LIVE_DIVIDER_VISUAL_OWNER=NAIVE_N_LAYOUT_SIDER_BORDER
LIVE_DIVIDER_WIDTH_AUTHORITY=--ui-admin-border-width
LIVE_DIVIDER_COLOR_AUTHORITY=color.border.default
LIVE_DIVIDER_RENDERING_MECHANISM=NAIVE_INTERNAL_BACKGROUND_STRIP
...
IMAGE_PAIR_GEOMETRY_OVERRIDE=PROHIBITED
RAW_DIVIDER_WIDTH=PROHIBITED
JAVASCRIPT_GEOMETRY_MEASUREMENT=PROHIBITED
```
...
`stylelint.config.mjs` 移除精确 `margin-inline-start: calc(-1 * var(--ui-admin-border-width))` 例外，使该负值重新在所有文件被拒绝；完整 Global Spacing Policy 及精确 Full Duration File Override 保持不变，不增加 Overflow 例外。既有 Router Checker 的独立 Divider Governance 入口保护 Live Authority、唯一 Image-pair Clip、无 Mirror/负 Margin/Geometry Compensation 与真实 Stylelint 正反例；仅使用可逆内存 Probe，不读取 Production Rule Cardinality 作为此窄检查的前提，并继续接入正常 Route Transition Governance，不豁免 Production Rule Inventory；后续 Owner 确认的正式 Axis Rule 按下述五条精确清单验证。

该 Divider 窄修复原位替换无效的 Group Mirror，保留 Private Provider Width Override 与 Group Animation Timing Ownership；当时保留临时七条比较规则，只执行定向检查及 Production Build，没有以完整 `pnpm verify` 接受临时规则。Owner 随后明确给出“分隔线修复验收通过，默认选择 Axis”，并确认十个工作区页面按当前 Sidebar 顺序使用 Axis Forward/Reverse。此验收只限已修复的分隔线，不恢复工作包整体 Runtime、Visual、Accessibility 或 Release Acceptance。当前已移除三条 Owner Preview Rule，并准入一条正式 Workspace Ordered Axis Rule；完整生产清单为五条，检查器精确保护此清单而非豁免临时规则。该默认选择不改 Divider、四种 Recipe、Full/Reduced/None Timing、Motion Preference、Router、Presentation Commit、Dependency、Dynamic Root、Budget 或 Public API；该次生产规则收敛按当时授权通过完整 `pnpm verify`，当时不暂存、提交、推送或开始后继工作；后续独立验收与发布事实以下方收口记录为准。

#### Rule Registry 与 Route Meta
...
Rule 只能引用 Validated RouteName、RouteTransitionFamilyId、RouteTransitionPresetId、Integer Priority 和显式 Forward/Reverse/Fallback Preset ID。解析先比较 Higher Priority，再按 Exact Route Pair、Ordered Routes、Route Family、Global Default 的 Specificity 顺序选择；Equal Priority 且 Equal Specificity 必须使 Static Verification 失败，Declaration Order 不得暗中决胜。Unknown、Inactive、Invalid、Ambiguous 或 Missing Reference 必须 Fail Closed 到 `route-transition.none`。

`global-default` 与 `route-family` 没有路由顺序，方向始终为 `neutral`，使用非方向性的 Family Default；不能通过改写三个 Preset ID 假定 Forward/Reverse。`ordered-routes` 根据显式 RouteName 顺序产生 Forward/Reverse，`exact-route-pair` 根据配置的 From/To Pair 产生 Forward/Reverse。方向能力只读取既有 Preset Registry 的 `directionAware`：Global/Family 的三个 Preset 字段及所有 Rule 的 Neutral Fallback 都禁止方向预设；只有 Ordered/Exact 的 Forward/Reverse 字段可声明空间预设。无效映射在 Motion/Typed-support Projection 前被拒绝，Static Verification 失败，Runtime 正常 Router Navigation Bypass，不静默落入 Crossfade。既有私有 Pure Resolver 可接收只读 Rule 集合用于 Checker 内存验证，生产仍只消费唯一 Rule Registry，不形成另一配置入口。

Route Meta 后续只能增加 `routeTransitionFamilyId`：当前十个 Product Route 全部映射 `route-family.architecture-workspace`，七个 Error Route 全部映射 `route-family.error`，Exact Meta Key Count 从 15 增至 16。Per-route Preset、Pair、Order、Direction、Vendor Config、Animation Parameter、Callback、CSS 和 Keyframe 均禁止进入 Route Meta；Pair 与 Ordered Behavior 只属于 Rule Registry。

#### Boundary Registry 与 Pure Resolver
...
Initial Boundary 只允许 Workspace-to-workspace Edge，且 `view-transition-name` 必须在精确一个 `[data-scroll-owner="architecture-console-content"]` Owner 上投影。Header、Sidebar、Menu、Navigation Motion Lens、Drawer 和 Overlay Root 不获得 Transition Name，也不参与 Root Snapshot Animation。Boundary 不改 Overflow Ownership，不新增 Scroll Container、Route Wrapper、Product-page Marker 或 Real Outgoing DOM。

Pure Resolver 只接收 Validated From/To RouteName、Navigation Kind、Effective PAVP Motion、Route Families、Layout Profile、Native API Availability、Document Visibility 和 Active Transition State；只返回带 Reason 的 Bypass，或一个 Validated PAVP Preset ID、Boundary ID、Motion Projection 和 Direction。它不调用 Router，不写 History，不维护 Path Stack，不读写 Scroll，不转移 Focus，不持久化，不返回 Native ViewTransition Handle、Callback、CSS 或 Vendor Configuration。
...
修复后的 Coordinator 在 Update Callback 内、唯一 `router.push` 紧前创建一次精确 Reservation，先等待原始 Typed Router Result；NavigationFailure 原样返回并结算 Reservation，Redirect 或最终 RouteName/fullPath 不匹配时结算原 Reservation 并只 `skipTransition()` 当前请求拥有的 Visual Transition，不二次 Push 或改变 Router 最终状态。只有成功且仍为原 Eligible Target 的导航才继续等待 Router Presentation Commit Promise。现有 Router Lifecycle 以 Private Per-Router WeakMap 保存 Broker，在既有 `beforeEach` 创建 `navigationAttempts` 后，以 Exact Expected RouteName、Exact fullPath、Unique Private Symbol 与 Monotonic Runtime Sequence 把最新匹配 Reservation 一次性绑定到真实 normalized `to`；Direct Router Navigation 没有 Reservation 时行为不变。

成功 Resolution 只发生在现有 Route Contract、DOM/H1、Title、Focus、Block/Inline Scroll Owner 均验证完成，并按原顺序写完 Admin Region `scrollLeft` 与最终 `scrollTop` 之后。Navigation Duplicate、Cancel、Abort、Redirect、Route Validation Failure、Lazy/Router Error、Presentation Error、Supersession、Router Dispose、Coordinator Dispose 与 Stale Epoch 均确定性 Resolve Cancelled 或 Reject；真实 Router/Presentation Error 继续可观察，Visual Skip 不取消成功 Router Commit。Coordinator 不读取或写入 Title、Focus、Scroll，不新增 Timer、RAF、Polling、Observer、Global Listener、Persistence、Dependency、Dynamic Root、Budget、Visual Recipe 或 Public API。任何时刻最多一个 Active ViewTransition；新视觉 Transition 前对旧者调用 `skipTransition()`，但不为动画 Queue 或 Replay Navigation。`ready`、`updateCallbackDone`、`finished` 均必须有 Rejection Handling；真实 Router/Lazy-load Failure 继续 Propagate，Unsupported 或 Visual Skip 只是 Progressive-enhancement Bypass。本 Amendment 不冻结 `beforeResolve` Deferred-guard 方案，实施仍保持既有 Programmatic Navigation Path。
...
Coordinator、Resolver、Active Registries 和 Initial Recipe CSS 全部位于 Normal Application Closure，不创建 Feature-ready State、Lazy Route-transition Runtime 或 First-navigation Animation Loss。当前 Bundle Budgets 不变；任何后续修改若无法保持已准入的 Minimum Initial JavaScript Headroom，必须停止并请求独立 Budget Amendment，不得暗中新增 Dynamic Root 或提高 Budget。

专用源码目录精确为 `apps/web/src/app/router/route-transition/**`，包含上述七个责任命名文件。Existing Integration 精确限于 `apps/web/src/app/router/route-registry.ts`、`apps/web/src/app/router/router-lifecycle.ts`、`apps/web/src/app/console/ConsoleRouteFrame.vue`、`apps/web/src/app/styles/layers.css`、`scripts/architecture/check-router.ts`、`scripts/architecture/check-architecture-admin-console.ts` 与 `scripts/architecture/check-boundaries.ts`。`apps/web/src/App.vue`、`apps/web/src/app/router/router-meta.d.ts`、除 `packages/ui/src/adapters/naive/PavpNaiveConfigProvider.vue` 外的 `packages/ui/**`、Motion Vue Adapters、Runtime Kernel、Storage、Appearance Store/Persistence、Design System、Built-in Themes、Vite、Project Config、Engineering Manifest、Package Manifests、Workspace/Lockfile 和 Workflows 保持未修改。Product Page 不得直接 Import Route-transition Runtime。

该唯一 Provider 例外仅将永久 Naive Sider 分隔线宽度投影到 `--ui-admin-border-width`；不改变其他 UI Runtime、Public API、Motion Vue、NMenu、Header、Sidebar 结构或 Narrow Drawer 行为。
...
ROUTE_TRANSITION_OTHER_UI_IMPLEMENTATION=UNCHANGED
```

#### Architecture Owning Checker
...
ROUTE_TRANSITION_ARCHITECTURE_ADMISSION_NEGATIVE_PROBE_COUNT=12
ROUTE_TRANSITION_ARCHITECTURE_ADMISSION_PROBE_EXECUTION=REVERSIBLE_IN_MEMORY_ONLY
ROUTE_TRANSITION_ARCHITECTURE_ADMISSION_PROBE_RESIDUE=ZERO
ROUTE_TRANSITION_ARCHITECTURE_ONLY_MUTATION_PATHS=ARCHITECTURE.md;scripts/architecture/check-architecture-admin-console.ts
```

既有十二个可逆 In-memory Architecture-admission Probe 继续保护 Current Work、前序 Publication/Owner Statement、Frozen Admission、已由实施期 `OPEN / COMPLETE / PASS` 收口为 `ACCEPTED / COMPLETE / PASS` 的状态、Technology、PAVP-RUNTIME-005、Preset、Route Meta、Rule Precedence、Initial Navigation Scope、Dynamic Root 与 Successor Boundary。源码 Landing 现由既有 Router、Admin Console 与 Boundary Checker 内精确 52 项 Source Proof、12 个保留的可逆 Source Probe，8 个只修改 In-memory Source Snapshot 的 Router Presentation Commit Probe，7 个 Preset Selection Probe，9 个 Full Pace Probe，以及 3 个 Stylelint Policy Probe 保护，覆盖 Route Meta、Preset/Default、Rule Ambiguity、Error Edge、Motion None、Preload Order、Single Push、Active Interruption、Name Ownership、Reduced Spatial Ban、Live DOM/Root Snapshot Ban、精确 Reservation/normalized `to` Binding、Title/H1/最终 Region Scroll 后 Resolution、Failure/Redirect/Supersession/Disposal Settlement，以及 Dependency/Dynamic-root/Budget/Focus/Scroll/Timer/Observer/RAF/Geometry Boundary。新增 Proof 直接调用真实 Pure Resolver 验证 Ordered/Exact 的双向 Full、Reduced、None、Typed-support Fallback 与 Neutral 字段拒绝，并检查有效 Typed Selector、Animation-name Specificity/Source Order 和 Reduced/None 优先级。每个 Probe 只因精确目标 Failure Code 失败、完整恢复并保持零 Artifact；所有无关既有 Checker Suite 保持不变。 Stylelint Policy Proof 使用真实配置与内存 CSS 检查精确路径、精确 Property/Value、其他路径拒绝、半时长兼容、裸时长/近似公式/Shorthand 拒绝；精确三个 Policy Probe 分别拒绝 Global Allowlist 扩张、File Scope 扩张和 Raw/Broad Declaration 准入，不写临时文件。
...
ROUTE_TRANSITION_IMPLEMENTED_PRESET_RECORDS=route-transition.none;route-transition.content-crossfade;route-transition.axis-inline-soft;route-transition.drill-soft;route-transition.sheet-soft
ROUTE_TRANSITION_IMPLEMENTED_PRESET_RECORD_COUNT=5
ROUTE_TRANSITION_IMPLEMENTED_VISUAL_RECIPE_COUNT=4
ROUTE_TRANSITION_ACTIVE_RULES=route-transition-rule.global-default:route-transition.content-crossfade;route-transition-rule.architecture-workspace:route-transition.content-crossfade;route-transition-rule.architecture-workspace-axis:route-transition.axis-inline-soft;route-transition-rule.architecture-workspace-error:route-transition.none;route-transition-rule.error:route-transition.none
...
ROUTE_TRANSITION_IMPLEMENTED_BYPASS_MATRIX=INITIAL_OR_HARD_RELOAD;CURRENT_ROUTE;REPLACE;REDIRECT;TRAVERSE_BACK;TRAVERSE_FORWARD;RECOVERY;ERROR_NAVIGATION;ANY_ERROR_FAMILY_EDGE;MOTION_NONE;UNSUPPORTED_NATIVE_API;HIDDEN_DOCUMENT;MISSING_BOUNDARY;DUPLICATE_BOUNDARY;INVALID_LAYOUT_PROFILE;INVALID_OR_AMBIGUOUS_RULE;UNKNOWN_REFERENCE
...
ROUTE_TRANSITION_TYPED_FALLBACK=TYPED_OPTIONS_WHEN_SELECTOR_SUPPORTED;CALLBACK_ONLY_CONTENT_CROSSFADE_WHEN_UNSUPPORTED;SPATIAL_DOWNGRADE_TO_CONTENT_CROSSFADE;ONE_CALLBACK_ONLY_RETRY_AFTER_PRE_UPDATE_SYNCHRONOUS_THROW;NO_SECOND_PUSH_AFTER_UPDATE_START
ROUTE_TRANSITION_TRANSIENT_DIRECTION_PROJECTION=data-pavp-route-transition-direction:forward,reverse,neutral:DOCUMENT_ELEMENT_ONLY:OWNED_CLEANUP
ROUTE_TRANSITION_FULL_CONTENT_CROSSFADE=PARALLEL_OLD_1_TO_0_AND_NEW_0_TO_1;NO_SPATIAL_EFFECT;DURATION_TOKEN;EASING_TOKEN;ZERO_INITIAL_DELAY;FILL_BOTH
ROUTE_TRANSITION_FULL_AXIS_INLINE_SOFT=DIRECTION_AND_WRITING_MODE_AWARE;ONE_spacing.content.gap_MAXIMUM;NO_SCALE_ROTATION_BLUR_PERSPECTIVE_OR_GEOMETRY_INTERPOLATION
ROUTE_TRANSITION_FULL_DRILL_SOFT=FORWARD_1_TO_0.985_AND_1.015_TO_1;REVERSE_1_TO_1.015_AND_0.985_TO_1;CENTER_TOP;NO_TRANSLATION_OR_BLUR
ROUTE_TRANSITION_FULL_SHEET_SOFT=FORWARD_OLD_FADE_AND_NEW_BLOCK_END_ONE_spacing.content.gap_TO_ZERO;REVERSE_OLD_TO_BLOCK_END_AND_NEW_FADE;NO_GEOMETRY_SHADOW_FILTER_OR_RADIUS_CHANGE
ROUTE_TRANSITION_REDUCED_BEHAVIOR=ALL_VISUAL_PRESETS_PROJECT_TO_PERCEPTIBLE_CONTENT_CROSSFADE;NO_TRANSFORM_SCALE_TRANSLATION_ROTATION_PERSPECTIVE_BLUR_OR_FILTER
ROUTE_TRANSITION_NONE_BEHAVIOR=COORDINATOR_BYPASS;DEFENSIVE_IMMEDIATE_FINAL_SNAPSHOT_STATE
ROUTE_TRANSITION_RUNTIME_005_PRESERVATION=ONE_ROUTER_VIEW;ONE_STABLE_UNKEYED_ROUTE_CONTENT_HOST;NO_LIVE_DOM_ROUTE_ANIMATION;BROWSER_STATIC_SNAPSHOTS_ONLY
ROUTE_TRANSITION_NEW_NPM_DEPENDENCIES=0
ROUTE_TRANSITION_NEW_DYNAMIC_ROOTS=0
ROUTE_TRANSITION_BUNDLE_BUDGET_CHANGE=NONE
...
HISTORICAL_ROUTE_TRANSITION_OWNER_RUNTIME_ACCEPTANCE=NOT_PERFORMED
HISTORICAL_ROUTE_TRANSITION_OWNER_VISUAL_ACCEPTANCE=NOT_PERFORMED
HISTORICAL_ROUTE_TRANSITION_OWNER_ACCESSIBILITY_ACCEPTANCE=NOT_PERFORMED
```

#### Owner Acceptance and Publication Closure

本节在精确实现提交已发布且两项 Hosted Gate 成功后记录 Owner 限定验收；Admission Amendment 与此前实施过程保持历史事实，不创建新工作包。Owner 原文：完美 通过了，越来越好了。

```text
OWNER_ACCEPTANCE_STATEMENT=完美 通过了，越来越好了
IMPLEMENTATION_COMMIT=083b527b567287544b3786cd4350ee713f6a59f3
PUBLICATION_TARGET=origin/main
HOSTED_IMPLEMENTATION_STATIC_VERIFICATION_RUN_ID=33871197154
HOSTED_IMPLEMENTATION_STATIC_VERIFICATION_CONCLUSION=success
HOSTED_IMPLEMENTATION_CODEQL_RUN_ID=33871197155
HOSTED_IMPLEMENTATION_CODEQL_CONCLUSION=success
HISTORICAL_ROUTE_TRANSITION_ADMISSION_STATE=OPEN / NOT_STARTED / NOT_RUN
HISTORICAL_ROUTE_TRANSITION_PRE_PUBLICATION_STATE=OPEN / COMPLETE / PASS;OWNER_ACCEPTANCE_NOT_PERFORMED;PUBLICATION_NOT_PUBLISHED
ROUTE_TRANSITION_ACCEPTED_SCOPE=TEN_WORKSPACES_ORDERED_AXIS_FULL_FORWARD_REVERSE;REDUCED_OPACITY_ONLY_CROSSFADE;NONE_DIRECT_ROUTER_NAVIGATION;IMAGE_PAIR_OVERFLOW_CLIP;PERMANENT_NAIVE_DIVIDER_TOKEN_WIDTH
ROUTE_TRANSITION_ACCEPTED_DIVIDER_RESULT=NO_OWNER_OBSERVED_BLINK_THINNING_DARKENING_DOUBLE_LINE_OR_DISPLACEMENT
ROUTE_TRANSITION_UNACCEPTED_SCOPE=ACCESSIBILITY;BROWSER_BACK_FORWARD_TRANSITION;ERROR_ROUTE_TRANSITION;FUTURE_DRILL_PRODUCTION_USE;FUTURE_SHEET_PRODUCTION_USE;OVERALL_ADMIN_CONSOLE_ACCEPTANCE;PRODUCTION_RELEASE
ROUTE_TRANSITION_ACCEPTANCE_CLOSURE_PROBES=REVERSIBLE_IN_MEMORY_ONLY
```

十个工作区 Full Axis Forward/Reverse 按已确认 Sidebar 顺序运行；Reduced 仅作 Opacity Crossfade，None 立即正常 Router Navigation。Owner 接受 Image-pair Overflow Containment 和永久 Naive 分隔线 Token Width；仅在 Owner 观察范围内确认无闪烁、变细、变暗、双线或位移。Accessibility 保持 `NOT_PERFORMED`，不推导 Back/Forward、Error Route、未来 Drill/Sheet 生产使用或 Production Release 验收。整体 Admin Console Runtime、Visual、Accessibility、Product Experience 与 Release Acceptance 保持撤销。所有 Current Work 已清空为 `NONE`，没有后继工作获得授权。
...
WORK_PACKAGE_KIND=BOUNDED_PRODUCTION_BUNDLE_MAINTENANCE_NOT_NEW_CAPABILITY
STATUS=COMPLETE
...
BASELINE_INITIAL_CSS_GZIP_BYTES=22685
FINAL_INITIAL_CSS_GZIP_BYTES=22685
INITIAL_CSS_HARD_BUDGET_BYTES=40960
LAZY_ROUTE_COUNT=17
INDEPENDENT_LAZY_ROUTE_CLOSURE_COUNT=17
LAZY_ROUTE_JAVASCRIPT_HARD_BUDGET_BYTES=122880
GENERATED_DESIGN_TOKEN_MANIFEST_GZIP_HARD_BUDGET_BYTES=32768
HARD_BUDGET_CHANGE=NONE
PROVEN_INITIAL_GRAPH_CAUSE=the startup-reachable Appearance schemas and Theme Registry imported the Color.js default OOP root, which statically registered every bundled color space and optional OOP extension even though the active CSS Color contract consumes only standard CSS color spaces plus parse, sRGB gamut, alpha and WCAG 2.1 contrast operations
CORRECTION=one private Design System css-color operation owner consumes the existing colorjs.io/fn public entry and registers only standard CSS Color 4 spaces before parse; Appearance schemas and Theme Registry retain their existing validation results through that owner
ROUTE_ONLY_MODULES_IN_INITIAL_STATIC_CLOSURE=NONE
STARTUP_CRITICAL_MODULES_REMAIN_IN_INITIAL_STATIC_CLOSURE=Runtime Kernel;Router lifecycle;Storage lifecycle;Appearance Provider;UiProvider;UiAdminShell
DEPENDENCY_CHANGE=NONE
LOCKFILE_CHANGE=NONE
...
STORAGE_REGISTRY_RECORDS=2
BUILT_IN_THEME_COUNT=14
CUSTOM_THEME_CAPABILITY=PRESERVED
...
该 Maintenance 不改变 Product Capability、启动顺序、First Paint Handoff、Router、Storage、Appearance、UI、Material、Motion、Layout、Focus、Scroll、Accessibility、页面内容或可见行为。Color.js 依赖与版本保持不变；只把 Runtime Initial Closure 从会静态纳入全部 Color.js 扩展的默认 OOP Root 收敛到同一依赖已公开的 Tree-shakeable Functional Entry，并继续覆盖 Architecture 允许的标准 CSS Color 4 语法、sRGB Gamut、Alpha 与 WCAG 2.1 Contrast。现有 Appearance Cutover Owner 冻结该 Import Ownership 并执行两个可逆 In-memory Negative Probes；Bundle Owner 保持全部 Hard Budget、精确十七条独立 Lazy Route Closure，并新增至少 `8192` Bytes Initial JavaScript Headroom 的硬失败条件。静态完成不恢复任何已撤销的 Owner Runtime、Visual、Accessibility、Product Experience 或 Release Acceptance。

### 1.2B.0 当前 Runtime Defect Remediation Register

#### `PAVP_RUNTIME_003_ADMISSION_AMENDMENT`

```text
AMENDMENT=PAVP_RUNTIME_003_ADMISSION_AMENDMENT
AMENDMENT_KIND=ARCHITECTURE_ONLY_BOUNDED_DEFECT_ADMISSION
AMENDMENT_STATUS=FROZEN
NORMATIVE_WRITE_AUTHORITY=ARCHITECTURE.md
SOURCE_IMPLEMENTATION_IN_THIS_AMENDMENT=PROHIBITED
SOURCE_IMPLEMENTATION_AUTHORITY=PAVP-RUNTIME-003_ONLY_UNDER_THIS_FROZEN_CONTRACT
ACTIVATION_EFFECT=CANONICAL_DEFECT_REMEDIATION_WORK_ITEM_ADMISSION_ONLY
WORK_ITEM=PAVP-RUNTIME-003
...
本 Amendment 只正式准入已经证明的 Narrow Navigation Modal Drawer Pointer and Focus Containment Defect，并冻结未来原子源码修复的唯一合同。它不实施 Drawer Source Repair，不修改 Application、UI、Design System、Generated Source、Dependency 或 Lockfile，不恢复整体 Admin Console Acceptance，也不准入 `PAVP-RUNTIME-004` 或任何后继工作。

##### Exact defect identity

```text
PAVP_RUNTIME_003_DEFECT_IDENTITY=NARROW_MODAL_DRAWER_FULL_VIEWPORT_POINTER_AND_FOCUS_CONTAINMENT_FAILURE
DEFECT_IDENTITY_SNAPSHOT=PRE_REPAIR_AT_ADMISSION
APPLICABLE_PROFILE=NARROW
APPLICABLE_PRODUCT_ROUTE_COUNT=10
MODAL_REPRESENTATION=Drawer
CURRENT_OUTER_LAYER=.pavp-admin-shell__drawer-layer
CURRENT_OUTER_LAYER_POSITION=fixed
CURRENT_OUTER_LAYER_INLINE_SIZE=restricted by layout.admin.drawer.maximum-inline-size
CURRENT_DRAWER_MAXIMUM_INLINE_SIZE_APPROXIMATION=20rem
CURRENT_390PX_VIEWPORT_LAYER_COVERAGE_APPROXIMATION=288px
CURRENT_390PX_VIEWPORT_EXPOSED_APPROXIMATION=102px
PROVEN_EXTERNAL_PRIMARY_POINTER_RESULT=focus may move from Drawer close button to body while Drawer remains open
PROVEN_MODAL_STATE_AFTER_FAILURE=aria-modal true; routed Main inert; Drawer open
DEFECT_CLASS=modal pointer and focus containment failure
PRESERVED_VALID_BEHAVIOR=opening focus;Tab and Shift+Tab cycling;Escape close;close button;current-route activation;different-route navigation;focus return
BLOCKED_ACCEPTANCE=Runtime;Visual;Accessibility;Release
```

##### Frozen structural, material and viewport-containment contract

实施源码在现有 Teleport 内精确使用两个职责不同的结构层：一个 Full-viewport Outer Drawer Overlay Layer，以及其子级的 Bounded Inner Drawer Navigation Panel。

```text
OUTER_DRAWER_OVERLAY_LAYER_OWNER=UiAdminShell
OUTER_DRAWER_OVERLAY_LAYER_TELEPORT_TARGET=#pavp-overlay-root
OVERLAY_ROOT_COUNT=1
OUTER_DRAWER_OVERLAY_LAYER_POSITION=fixed
OUTER_DRAWER_OVERLAY_LAYER_LOGICAL_INSET=0
OUTER_DRAWER_OVERLAY_LAYER_VISUAL_VIEWPORT_COVERAGE=COMPLETE
OUTER_DRAWER_OVERLAY_LAYER_SCRIM_OWNER=YES
OUTER_DRAWER_OVERLAY_LAYER_SCRIM_ROLE=color.scrim.viewport
OUTER_DRAWER_OVERLAY_LAYER_SCRIM_CONSUMPTION=generated PAVP CSS variable
OUTER_DRAWER_OVERLAY_LAYER_Z_INDEX_AUTHORITY=existing PAVP z-index authority
OUTER_DRAWER_OVERLAY_LAYER_POINTER_INTERCEPTION=complete viewport
OUTER_DRAWER_OVERLAY_LAYER_DRAWER_MAXIMUM_INLINE_SIZE_CONSUMPTION=PROHIBITED
OUTER_DRAWER_OVERLAY_LAYER_TRANSFORM_TRANSLATE_SHRINK_OR_SLIDE=PROHIBITED
OUTER_DRAWER_OVERLAY_LAYER_LEAVE_LIFETIME=present and pointer-intercepting until the Drawer transition completes and the Overlay is removed
INNER_DRAWER_NAVIGATION_PANEL_PARENT=full-viewport Outer Drawer Overlay Layer
INNER_DRAWER_NAVIGATION_PANEL_DRAWER_MAXIMUM_INLINE_SIZE_CONSUMPTION=EXCLUSIVE
INNER_DRAWER_NAVIGATION_PANEL_MAXIMUM_INLINE_SIZE_AUTHORITY=layout.admin.drawer.maximum-inline-size
INNER_DRAWER_NAVIGATION_PANEL_MAXIMUM_INLINE_SIZE=20rem
INNER_DRAWER_NAVIGATION_PANEL_BLOCK_SIZE=complete viewport block size
INNER_DRAWER_NAVIGATION_PANEL_BACKGROUND=existing PAVP Material overlay background
INNER_DRAWER_NAVIGATION_PANEL_SAFE_AREA_PADDING=PRESERVED
INNER_DRAWER_NAVIGATION_PANEL_NAVIGATION_CONTENT=PRESERVED
INNER_DRAWER_NAVIGATION_PANEL_ROLE=dialog
INNER_DRAWER_NAVIGATION_PANEL_ARIA_MODAL=true
INNER_DRAWER_NAVIGATION_PANEL_ACCESSIBLE_LABEL=PRESERVED
INNER_DRAWER_NAVIGATION_PANEL_TABINDEX=-1 where required by the existing focus contract
INNER_DRAWER_NAVIGATION_PANEL_LOCAL_SLIDE_TRANSFORM=ONLY_PERMITTED_DRAWER_TRANSFORM_OWNER
SECOND_PROVIDER_SHELL_ROUTER_OUTLET_OVERLAY_ROOT_DRAWER_STATE_SCROLL_OWNER_OR_FOCUS_SYSTEM=PROHIBITED
```

##### Frozen external-pointer and focus-return contract

未来实现只允许在 Full-viewport Scrim 上增加一个 Private、Narrowly-owned Handler。Preferred Event Boundary 精确为 `pointerdown`；Handler 必须接收真实 `PointerEvent`，且只有 `event.button === 0` 与 `event.target === event.currentTarget` 同时成立时才能关闭 Drawer。

```text
EXTERNAL_POINTER_HANDLER_VISIBILITY=PRIVATE
EXTERNAL_POINTER_HANDLER_OWNER=full-viewport Scrim
EXTERNAL_POINTER_EVENT_BOUNDARY=pointerdown
EXTERNAL_POINTER_EVENT_TYPE=PointerEvent
EXTERNAL_POINTER_PRIMARY_GUARD=event.button === 0
EXTERNAL_POINTER_SELF_TARGET_GUARD=event.target === event.currentTarget
EXTERNAL_POINTER_CLOSE_ORDER=event.preventDefault() before closeNavigation()
EXTERNAL_POINTER_CLOSE_LIFECYCLE=existing closeNavigation()
EXTERNAL_POINTER_PRIMARY_SCRIM_RESULT=Drawer closes without focus transfer to body
EXTERNAL_POINTER_FOCUS_RETURN=existing watch(navigationOpen) restores focus to the existing navigation trigger
INNER_PANEL_POINTER_RESULT=does not close Drawer
NON_PRIMARY_SCRIM_POINTER_RESULT=does not close Drawer
GLOBAL_POINTER_LISTENER=document,window,body,#app all prohibited
COMPENSATING_FOCUS_RESTORATION=PROHIBITED
TIMER_OR_SCHEDULING_REPAIR=PROHIBITED
```

##### Frozen Motion containment contract

现有 Vue Transition 可以保留，但 Transition State Class 在 Outer Overlay 上只作为状态载体；Transform 与 Transition Declaration 必须只作用于 Inner Drawer Panel。Outer Overlay 在完整 Leave 生命周期中保持 Fixed、Full-size、Untransformed 与 Pointer-intercepting。

```text
DRAWER_TRANSITION_STATE_CARRIER=Outer Overlay Layer allowed
DRAWER_TRANSFORM_AND_TRANSITION_TARGET=Inner Drawer Navigation Panel only
OUTER_DRAWER_OVERLAY_TRANSFORM=none under full,reduced,none
FULL_MOTION_DRAWER=existing admitted local Drawer transition on Inner Panel only
REDUCED_MOTION_DRAWER=existing shortened local displacement and duration on Inner Panel only
NONE_MOTION_DRAWER=no non-essential transition or transform
OVERLAY_POINTER_INTERCEPTION_DURING_LEAVE=required under full,reduced,none
FULL_VIEWPORT_OPACITY_FILTER_BACKDROP_FILTER_OR_TRANSFORM_ANIMATION=PROHIBITED
GLOBAL_MOTION_AUTHORITY_CHANGE=NONE
```

##### Preserved behavior and prohibited repair techniques

未来修复必须保持：现有 Close Button Initial Focus、Tab/Shift+Tab Focus Cycle、Escape Close、Close-button Lifecycle、Trigger Focus Return、Current-route Drawer Close and Focus Return、Different-route Single Navigation and New H1 Focus、Main `inert`、Root/Body Scroll Lock、Wide Sidebar、Regular Rail、`PAVP-RUNTIME-002` Guard、Router Focus/Scroll、Safe Area、Forced Colors、Reduced Transparency、Material 与 Motion Authorities。

明确禁止：把 Inner Panel 做成 Full-viewport Width；保留 `20rem` Outer Scrim；Document/Window/Body/`#app` Pointer Listener；Teleport to `body`；Second Teleport Target 或 Overlay Root；Raw Color、Opacity、z-index、Breakpoint、Drawer Width 或 Motion Duration；Page-authored CSS Variable；`blur()`；External Pointer 后补偿 Focus；`setTimeout`；`requestAnimationFrame`；New `nextTick` Repair Path；Complete Overlay `pointer-events:none`；移除 `aria-modal` 或 Main `inert`；禁用 Navigation Button；改变 Router Focus/Scroll；新增 Dependency；替换 Vendor Drawer；改变 Product-page Content/Visual Hierarchy；改变 Runtime Kernel、Storage、Provider、Appearance Persistence、Route Identity 或 Theme Data。

##### Frozen future source scope and static governance

```text
FUTURE_SOURCE_SCOPE_1=packages/ui/src/components/UiAdminShell.vue
FUTURE_SOURCE_SCOPE_2=scripts/architecture/check-architecture-admin-console.ts
FUTURE_SOURCE_SCOPE_3=ARCHITECTURE.md
FUTURE_SOURCE_SCOPE_EXPANSION=STOP_AND_PROVE_DIRECT_MATERIAL_REQUIREMENT
DEPENDENCY_CHANGE=NONE
LOCKFILE_CHANGE=NONE
...
Current Implementation Owning Gate 证明：Exactly One Full-viewport Outer Overlay；Outer/Inner Distinct Nodes；Outer Fixed with Logical Inset `0`；Outer 不消费 Drawer Maximum Role；Inner 独占该 Role；Scrim 消费 `color.scrim.viewport`；Teleport Target 精确不变且 Overlay Root 恰好一个；Scrim 使用 Exact Primary `pointerdown` Handler；Primary 和 Self-target Guards 同时存在；`preventDefault()` 先于 `closeNavigation()`；Inner Pointer 与 Non-primary Pointer 不关闭；无 Global Pointer Listener；Outer 无 Drawer Transform；只有 Inner 有 Drawer Motion；Leave 期间 Outer 持续 Pointer-intercepting；`role="dialog"` 与 `aria-modal="true"` 位于 Inner；Main Inert、Scroll Lock、Focus Trap、Escape、Initial Focus 和 Focus Return 保持；Wide/Regular、`PAVP-RUNTIME-002`、17 Routes、11 Kernel Steps、Provider `pinia,appearance`、2 Storage Records、14 Themes、Dependencies 与 Lockfile 保持。

Current Owning Gate 执行并完全恢复下列十个可逆 In-memory Source Probes：限制 Outer 为 Drawer Maximum Width；移除 Full-viewport Inset；移除 Scrim Token；移除 Self-target Guard；移除 Primary-button Guard；加入 Document-level Pointer Listener；允许 Inner Pointer Close；把 Drawer Transform 移回 Outer；移除 `aria-modal`；移除 Main `inert`。十个 Probe 均在内存快照中运行并保持零 Repository Artifact。

本 Amendment 的五个既有 Admission-state In-memory Probes 继续保持：把明确标记为 Historical 的 Admission-time `CURRENT_BOUNDED_WORK` Literal 从 `PAVP-RUNTIME-003` 改为 `NONE`；替换该 Historical Literal 中的 Authorized Work ID；把已完成的 003 Repository Implementation 回退为 `NOT_STARTED`；把已通过的 003 Static Verification 回退为 `NOT_RUN`；恢复整体 Admin Console Acceptance。每个 Probe 都因预期原因失败、完全恢复且保持零 Artifact。
...
```text
PAVP_RUNTIME_003_OUTER_OVERLAY=complete-viewport fixed Overlay/Scrim with logical inset 0
PAVP_RUNTIME_003_OUTER_OVERLAY_SCRIM_ROLE=color.scrim.viewport
PAVP_RUNTIME_003_OUTER_OVERLAY_POINTER_INTERCEPTION=complete viewport through leave
PAVP_RUNTIME_003_INNER_PANEL=bounded Drawer Navigation Panel
PAVP_RUNTIME_003_INNER_PANEL_MAXIMUM_INLINE_SIZE_AUTHORITY=layout.admin.drawer.maximum-inline-size
PAVP_RUNTIME_003_SCRIM_POINTER_HANDLER=private primary pointerdown on Outer Scrim only
PAVP_RUNTIME_003_SCRIM_POINTER_GUARDS=event.button equals 0 and event.target equals event.currentTarget
PAVP_RUNTIME_003_SCRIM_POINTER_ACTION_ORDER=event.preventDefault before closeNavigation
PAVP_RUNTIME_003_FOCUS_RETURN=existing watch(navigationOpen) lifecycle preserved
PAVP_RUNTIME_003_DRAWER_MOTION_TARGET=Inner Drawer Navigation Panel only
PAVP_RUNTIME_003_OUTER_OVERLAY_LEAVE_RESULT=full-size untransformed pointer-intercepting Scrim
PAVP_RUNTIME_003_REVERSIBLE_SOURCE_PROBE_COUNT=10
PAVP_RUNTIME_003_REVERSIBLE_SOURCE_PROBES=ACTIVE
HISTORICAL_SOURCE_TASK_PAVP_RUNTIME_003_OWNER_EXTERNAL_REVIEW=NOT_PERFORMED_OPTIONAL_EXTERNAL_NON_GATING
```

##### Frozen status transition and Owner external review

```text
BEFORE_SOURCE_IMPLEMENTATION_PAVP_RUNTIME_003_STATUS=OPEN
BEFORE_SOURCE_IMPLEMENTATION_PAVP_RUNTIME_003_REPOSITORY_IMPLEMENTATION=NOT_STARTED
BEFORE_SOURCE_IMPLEMENTATION_PAVP_RUNTIME_003_STATIC_VERIFICATION=NOT_RUN
AFTER_SUCCESSFUL_SOURCE_AND_CANONICAL_STATIC_GATE_TASK_REPORT_STATUS=COMPLETED
AFTER_SUCCESSFUL_SOURCE_AND_CANONICAL_STATIC_GATE_PAVP_RUNTIME_003_STATUS=OPEN
AFTER_SUCCESSFUL_SOURCE_AND_CANONICAL_STATIC_GATE_PAVP_RUNTIME_003_REPOSITORY_IMPLEMENTATION=COMPLETE
AFTER_SUCCESSFUL_SOURCE_AND_CANONICAL_STATIC_GATE_PAVP_RUNTIME_003_STATIC_VERIFICATION=PASS
OPEN_TO_ACCEPTED_TRANSITION_AUTHORITY=SEPARATE_LATER_EXPLICIT_OWNER_REVIEW_AND_GIT_CLOSURE_TASK_ONLY
PENDING_OWNER_STATUS_MODEL=PROHIBITED
CODEX_BROWSER_OPERATION=PROHIBITED
OWNER_EXTERNAL_REVIEW_KIND=INFORMATIONAL_ONLY
OWNER_OBSERVATION_REPOSITORY_EVIDENCE_FILE=PROHIBITED
```

Owner External Review Matrix 只供信息使用：在 Narrow Width 检查 `/`、`/appearance`、`/capabilities`；Scrim 覆盖完整 Viewport；Primary Scrim Pointer Close 并返回 Trigger Focus；Inner Primary Pointer 与 Non-primary Scrim Pointer 不关闭；Tab/Shift+Tab、Escape、Current-route、Different-route Single Navigation 与 New H1 Focus 保持；不存在 Drawer Open 且 Focus 落到 `body`；`full`、`reduced`、`none` 保持同一 Containment Result。该 Matrix 不授权 Codex Browser Operation，也不创建 Repository Evidence。

Owner 随后在独立且显式授权的验收与 Git 收口任务中，对已发布实施提交 `3fa078ab75322a17e5e4514d0805f1efea06981b` 陈述 `那没问题`。该陈述只使 `PAVP-RUNTIME-003` 的 Runtime、Visual 与 Accessibility Acceptance 成为 `PASS`，并把该 Work Item 收口为 `ACCEPTED / COMPLETE / PASS`；它不恢复整体 Admin Console Product Experience、Runtime、Visual、Accessibility 或 Release Acceptance，不准入 `PAVP-RUNTIME-004`、Successor Package 或任何新实现工作。
...
HISTORICAL_CURRENT_BOUNDED_WORK=PAVP-RUNTIME-005
...
§1.2B.0N 只窄替换 PAVP-RUNTIME-005 对 Browser-created Static Snapshot 的 Blanket Prohibition，不替换上述 Live DOM Contract。`PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY` 已在后续独立授权下只使用 Native Document View Transition API 动画 Browser-created Pseudo-element Snapshot；任何 Live Route DOM Animation、Route-derived Key、Routed-component Key、Real Outgoing DOM Retention 或 Deliberate Blank Frame 仍被禁止。
...
| 4 | `runtime-kernel-inspector` | `/runtime-kernel` | `apps/web/src/pages/runtime-kernel.vue` | `运行时内核` | `route-title.runtime-kernel-inspector` | `route-message.runtime-kernel-inspector-summary` | `查看当前十二阶段启动流程、Provider 与生命周期边界。` | `route-breadcrumb.runtime-kernel-inspector` | `route.console.runtime-kernel` |
...
CAPABILITY_MANIFEST_RECORD_COUNT=21
...
Status Aggregation 是 Conservative Least-ready Projection：`ACTIVE=0`、`TARGET_INACTIVE=1`、`DEFERRED=2`，Mapped Source 取最大 Rank；任何 `PROHIBITED` Source 被 Mapping 时直接失败。Derived `implementationStatus` 精确为 `ACTIVE → complete`、`TARGET_INACTIVE → not-started`、`DEFERRED → deferred`。Appearance 或本实例 I18n 且 Active 才是 `active-interactive`；其他 Active 为 `active-read-only`；非 Active 为 `roadmap-only`。每条非 `PROHIBITED` §1.3 Record 必须至少出现在以下一个 Mapping 中；重复 Source 只允许表中显式列出的 `Architecture Admin Console frontend surface`。
...
| `i18n` | `Existing Admin Console Chinese/English localization` |
...
§23.6 的既有实现已通过完整静态 Gate，本节唯一 Source 与既有生成器输出同步为 `21` 条真实实现投影，包含独立 `i18n` Record；Runtime Kernel 为十二阶段、Storage 为三条 Record，Combined Error 二十一条与 Public UI 九个组件保持。旧预算失败仍由 §23.6 保留为历史事实。静态完成只激活本实例明确范围，不代表 Owner Runtime Acceptance 或 Release，历史 Acceptance 与 Revocation 均保持。
...
```json
{
  ...
  "records": [
    ...
    { "id": "forms-i18n-tables", "visibleLabel": "表单、国际化与表格", "summary": "管理台双语已由独立 i18n Record 表示；表单、表格与通用工作流仍未实现。", "capabilityStatus": "TARGET_INACTIVE", "implementationStatus": "not-started", "presentationMode": "roadmap-only", "routeName": "capability-roadmap", "owner": "demand-driven-frontend", "prerequisiteIds": ["architecture-admin-console"], "admissionCondition": "需要一个真实消费者并一次只准入一个能力。", "interactive": false },
    {"id": "i18n", "visibleLabel": "管理台中英文", "summary": "现有管理台的中文与英文展示、语言切换和本地选择恢复。", "capabilityStatus": "ACTIVE", "implementationStatus": "complete", "presentationMode": "active-interactive", "routeName": "appearance-management", "owner": "apps/web/src/shared/i18n", "prerequisiteIds": ["architecture-admin-console", "router-governance", "runtime-kernel", "storage-persistence"], "admissionCondition": "仅限已实现的管理台双语范围；其他语言、账号同步及业务格式须另行准入。", "interactive": true},
    ...
    { "id": "runtime-kernel", "visibleLabel": "运行时内核", "summary": "当前十二阶段启动、Provider、错误与释放流程。", "capabilityStatus": "ACTIVE", "implementationStatus": "complete", "presentationMode": "active-read-only", "routeName": "runtime-kernel-inspector", "owner": "runtime-kernel", "prerequisiteIds": ["appearance"], "admissionCondition": "已激活。", "interactive": false },
    ...
    { "id": "storage-persistence", "visibleLabel": "存储与持久化", "summary": "当前三条非敏感本地存储记录及其生命周期。", "capabilityStatus": "ACTIVE", "implementationStatus": "complete", "presentationMode": "active-read-only", "routeName": "storage-persistence-inspector", "owner": "storage", "prerequisiteIds": ["router-governance"], "admissionCondition": "已激活。", "interactive": false },
...
| Application persistence architecture | `ACTIVE` | `PAVP_STORAGE_PERSISTENCE_IMPLEMENTATION` plus the one locale-preference record admitted by `PAVP_ADMIN_CONSOLE_LOCALIZATION`; three current records |
...
上图是最终允许方向，不表示依赖已进入当前 Phase。以下仅是 Phase 1 初始 Baseline 的历史快照，不是当前 Scoped-admission 状态：
...
│   │   └── gsap/                 [future demand-created gate; absent after §1.2B.0L retirement]
│   ├── internal/
...
CURRENT_EXTENSION_GATE=PAVP_ADMIN_CONSOLE_LOCALIZATION
IMPLEMENTATION_STATUS=COMPLETE
IMPLEMENTATION_COMMIT=3bb664f1d81d354ccb0ec7ddcc4219d54b5d7177
CURRENT_RUNTIME=exact twelve-step Runtime Kernel
ACTIVATION_PROVIDER_SET=pinia,appearance
ACTIVATION_BOOTSTRAP_STEP_COUNT=12
```
...
| Storage lifecycle | `app/storage` through the Runtime Kernel step | one ready Storage lifecycle handle for the exact three-record Registry | DOM Mount, Provider identity, Session persistence or top-level HMR ownership |
...
当前 Active Exact Contract 由 §19.5.1 的 Frozen Storage Protocol、§37.2.6 的 Completed Landing Record 及 §23.6.6 的限定 Locale Preference 扩展共同拥有；本 Step 是当前十二步 Registry 的第八步。它的 Exact Dependencies 仍为 `validate-build-and-runtime-configuration` 与 `install-platform-providers`；Registry Order 把它放在 Router 后、I18n 前，`mount-application` 显式依赖 Router、Storage 与已就绪 I18n。它在 Mount 前完成 Exact Three-record Storage Registry 的 Ready Boundary，产出一个幂等 `StorageLifecycleHandle`；Failure 归一化到 Existing Storage/Core Boundary 并阻止 Mount。它不是 `ACTIVATION_PROVIDER_SET` 成员，不建立第二个 Storage Authority。

#### `create-and-ready-i18n`

该第九步的完整 Typed Input、同步 Handle Registration、异步 Ready、Failure/Cancellation、Router Connection 与幂等 Disposal 合同只由 §23.6.5 拥有。其三条 Dependency 和 Mount Readiness 已由现有 Bootstrap Registry 实现；Provider Set 仍为 `pinia,appearance`。

#### `mount-application`

```text
dependencies=[create-and-ready-router,create-and-ready-storage,create-and-ready-i18n]
CreateInput=ready Vue App,ready RouterLifecycleHandle,ready StorageLifecycleHandle,ready ConsoleI18nBoundary,exact #app target
...
4. Dispose Console I18n Lifecycle (`dispose-i18n`)。
5. Dispose Storage Lifecycle (`dispose-storage`)。
6. Remove Router Hooks and Dispose Router/History。
7. Dispose Installed Platform-provider Handles。
8. Dispose Pinia。
9. Release Vue Application Creation Handle。
10. Release First Paint Handoff and Safety Handle。
11. Dispose Global Failure Capture。
12. Abort/Release Runtime Configuration Handle。
...
* Exact Twelve-step Bootstrap Registry、Dependency Graph Acyclicity、Current Provider Set、Unique Mount Owner、Exact Reverse Disposal Order 与 Idempotent Disposal。
...
这些规则已随 Runtime Kernel、Router、Storage 与 §23.6 管理台 I18n Implementation 激活，并且只证明当前十二步 Registry、Pinia/Appearance Provider Set、Core Runtime Configuration、四条 Core Error Record、六条 Router Error Extension、十一条 Storage Error Extension、当前 Listener、Retry、Router/History Disposal、Storage Disposal、Mount 和 HMR 合同。它们不激活或证明任何后续 Provider 或 Capability。
...
§23.6.6 已实现第三条 `locale-preference` Direct Record 及其窄 Port；本节原 Storage Landing 的两条记录、十一阶段及 Disposal 插入描述保留为该 Landing 历史，当前十二阶段与三条 Registry 由 §19.4 和 §23.6 拥有。原两条 Appearance Payload、零 Envelope/Migration/Cross-tab Event 与敏感数据边界保持。
...
ACTIVATION_STAGE=DEMAND_DRIVEN_FORMS_I18N_TABLES_AND_UI_ADMISSIONS
ACTIVATION_GATE_CREATION=PAVP_ADMIN_CONSOLE_LOCALIZATION_SCOPED_IMPLEMENTATION_COMPLETE_OTHER_I18N_REQUIRES_SEPARATE_ADMISSION
```
...
文首、§1.3、§37.1、§37.2 的 Current Work/Next/Successor 继续为现有状态，不续接历史验收或撤销记录。Owner 已授权同一实施任务完成以下增量及 Owning Checks；当前源码与唯一 Manifest Source/生成物已包含十二阶段 Kernel、三条 Storage Record 和二十一条 Capability 实现投影，Combined Error 仍为二十一、UI Component 仍为九。此前十一阶段、两条 Storage Record、二十条 Capability 的历史 Landing 与验收记录保持；当前状态按本实例及 §1.3 同步。

历史失败：§23.6.2 的声明补丁与 Router 纯输出/真实消费者类型边界修复均保留。此前 Vue 与完整 Node/Design System/UI Typecheck、Project-config、Architecture、资源/生成一致性、格式/Lint、Policy、Unused 与 Production Build 已通过；当时完整 `mise exec -- pnpm verify` 在 Bundle Gate 失败。按 §23.6.4 的日期适用性修正，实际生产图移除了两个 Naive Date Locale 与其 23 个 date-fns 模块，完整 Common Locale 保留。Initial JavaScript 从本次复现的 `237058` 降至 `232891 bytes gzip`，实际减少 `4167`；冻结预算 `237568` 仅剩 `4677`，低于最低 `8192`，距允许的最大实际值 `229376` 仍超出 `3515`。预算、依赖、编译器与加载分类未调整。当时状态为 `IN_PROGRESS/FAIL/TARGET_INACTIVE`，该失败不因新预算追溯改写。

本次按 §23.6.9 精确批准的预算调整后，完整 `mise exec -- pnpm verify` 已通过，包括此前被 Initial JS 失败阻挡的所有后续 Bundle 检查。现将限定管理台源码同步为 `COMPLETE/PASS/ACTIVE`；最终规范/生成同步后仍须再次通过完整静态 Gate 才能暂存。Owner Runtime Acceptance 为 `NOT_PERFORMED`，Release 为 `NOT_RELEASED`，历史验收与撤销不恢复。
...
现有 Vite/TypeScript Bundler Resolution 已支持 JSON Modules；本实例保留 Vue I18n 自带 JIT Compiler，随独立 Locale Runtime Chunk 加载。Vite 只设置官方 `__VUE_I18N_FULL_INSTALL__=false`、`__VUE_I18N_LEGACY_API__=false`，不移除当前需要的 Message Compiler。无需再安装预编译插件、CLI、Polyfill、日期库或新 Runtime Manager；已核验的 `@intlify/unplugin-vue-i18n@11.2.5` 不属于本次选定依赖。未来安装必须通过现有 Catalog/Lockfile 流程，保留单一 Vue、所有既有 Patch/Integrity/Strict-build Policy，不允许顺便升级。任何真实 Compatibility/Budget Failure 先作为阻塞报告；除下述 Owner 明确准入的声明兼容修正外，不能增加预算、Patch 或依赖来制造通过。

Owner 本次只授权 `vue-i18n@11.4.10` 对冻结 `vue@3.5.40` 的声明专化：通过 `mise exec -- pnpm patch vue-i18n@11.4.10` 和 `mise exec -- pnpm patch-commit <pnpm edit directory>` 生成 `patches/vue-i18n@11.4.10.patch`，仅修改 `dist/vue-i18n.d.ts` 的两处声明：删除 `GenericComponentInstance` 的 Vue Type Import；将 `MissingHandler` 的 `instance?: ComponentInternalInstance | GenericComponentInstance` 改为 `instance?: ComponentInternalInstance`。保留可选性、其余参数、返回类型、所有其他声明与导出；JavaScript、Package Metadata、入口和 Runtime 行为不得修改。该例外不等同两个实例类型，不支持 Vue 3.6/Vapor，不准入替代 Public Instance Type、Shim、Augmentation、Cast、Suppression、`skipLibCheck` 或 Resolution 绕过。

依据为 [11.4.10 Composer 源码](https://github.com/intlify/vue-i18n/blob/v11.4.10/packages/vue-i18n-core/src/composer.ts) 的 `defineCoreMissingHandler` 实际传入 `getCurrentInstance() || undefined`；[同版本 Wrapper](https://github.com/intlify/vue-i18n/blob/v11.4.10/packages/vue-i18n-core/src/utils.ts) 在 Bundler 中镜像 Vue 的 Instance Setter，缺席时调用 Vue Getter；[Vue 3.5.40 Instance 实现](https://github.com/vuejs/core/blob/fa2885d8c48768d26f1666a01bd540ffe3b20f9b/packages/runtime-core/src/component.ts) 的 Setter 与 Getter 只处理 `ComponentInternalInstance | null`，[公共导出](https://github.com/vuejs/core/blob/fa2885d8c48768d26f1666a01bd540ffe3b20f9b/packages/runtime-core/src/index.ts) 不含 `GenericComponentInstance`。上述 Vue Commit 经官方 3.5.40 Release Tag 核验。精确版本 Official npm Artifact 的 Integrity 必须与 Lockfile 一致；修正前 Installed Package 与原件相等，修正后除唯一 DTS Target 外全部文件逐字节相等，才能证明此声明专化适合当前单一 Vue 环境。

此次增量仅限该 Patch File、Root `pnpm-workspace.yaml` 的精确 `vue-i18n@11.4.10` Patch Mapping、pnpm 原生生成的 `pnpm-lock.yaml` Patch Identity/Snapshot References、`scripts/verify/check-project-config.ts` 的最小 Patch Admission/Hash/Identity/Integrity 检查，以及本节与对应准入记录。Catalog、Dependency Graph、旧 Patch 和 `allowUnusedPatches=false`、`ignorePatchFailures=false` 保持；Motion 历史记录的三项 Patch Set 保留，当前 Workspace 仅增加此一精确例外。任一 `vue-i18n` 或 `vue` 版本改变时必须重新核对官方声明、Instance 路径与兼容性，不得自动沿用补丁。

本次独立修正只运行 Frozen-lockfile Install、Vue/TS Typecheck、Effective Compiler Settings、Diff Whitespace、现有 Policy 与 Project-config Check；不运行完整 `verify`、Build、Bundle 或 Runtime Acceptance，不续做语言功能。其余 Localization Implementation 与 Owning Checks 仍未完成；解除单个 TS2724 不激活 Capability，也不将整体 Static Verification 或语言切换标为通过。
...
新增 Public Application Entry 为 `apps/web/src/shared/i18n/index.ts`；App/Page 的 Runtime Consumer 使用显式相对 Import 到该入口。Node 工具可达的同应用模块，其必要 Type-only Import 可直接指向现有 `locale-contract.ts`、`message-schema.ts` 或语言边界内其他已存在的纯声明所属模块，且须确认其传递依赖不引入 Browser Implementation；此例外不准入跨 Package Private Import。`packages/ui` 只能定义和导出自己的语义类型，不能 Import `apps/web`。共享语言模块不能 Import `app/router`、`app/storage`、`app/errors`、Page 或 Feature；Kernel 注入 Storage Port、初始 Scope 和 Router 标题回调。所有 Factory、Injection Key、Writable Ref、Composer、加载缓存和内部 Handle 均不能泄漏给 Page。
...
export function getConsoleNavigation(translate: ConsoleTranslate): readonly ConsoleNavigationGroup[]
...
`ConsoleNavigationGroup` 是 Router 拥有的只读 Navigation Presentation Output；`UiAdminNavigationGroup` 继续由 UI 拥有并约束 Component Input，两者保持结构兼容。Router 不通过 UI Type Import 或派生类型依赖 UI 实现，也不复制 Navigation Registry、Schema 或 Mutable State。`ConsoleRouteFrame.vue` 在传给 `UiAdminShell` 的实际响应式导航计算值上，以 Checked Return Annotation 或 `satisfies` 验证 `readonly UiAdminNavigationGroup[]`，类型仍从 `@platform/ui` 公共根导入；翻译保持在原 Reactive Evaluation 内，不增加 Cast、Unused Assertion 或测试专用 Helper。
...
初始化顺序：读取 Storage Port → 验证已保存选择 → 保证中文 Common 与初始 Route Scope 可用 → 为有效英文选择加载对应英文资源 → 同步完成同一 Instance 的必需插件注册 → 同步提交 Locale/Document Projection 并调用 Router 标题回调 → 提供应用 Boundary → Ready。未找到、非法或无法读取 Preference 时使用中文且不修复/覆写 Storage；有效英文 Resource 加载失败时保留原 Preference，回到已就绪中文，并保留 `saved-choice-unavailable` Notice。中文初始必需资源、Instance 创建/必需注册或默认提交失败属于当前 Step 的 Startup Failure；由 Kernel 恰好一次归一化为现有 `application-startup-failure`，停止 Mount/Ready 并反向释放。Raw Import URL、异常文案或 Storage Payload 不进入用户提示。

Owner 已授权修正把完整异步插件安装等同语言 Readiness 的旧解释。固定 `vue-i18n@11.4.10` 的浏览器安装实现先同步注册 Provider 与 Unmount Cleanup，随后才等待可选 DevTools；工具 Hook 不可用且未启用 Early Proxy 时，其回调可一直待决。每次 Attempt 仍恰好安装一次且先于 Mount，私有集成须确认必需同步注册完成，将此前的安装失败交回 Kernel；之后返回的可选 Promise 独立观察，不能进入 `ready` 或替代 Mount Barrier，失败仅在有效 Attempt 的 Development 中使用 Vue 现有 `warn` 诊断，不新增 Reporter、Error Registry 或重试。这个分界依据固定版本的实际实现，不将所有安装 Rejection 一概视为无害；版本改变须重新核对。保持正常 DevTools 接入；不修改 Vendor Runtime、Build Flags 或 Global Hook。Dispose 撤销应用后续提交资格，包括资源失败分支的 Notice；观察可选 Promise 不会取消上游排队回调或 Vendor Continuation。
...
4. 将完整资源交给同一 Composer 后，在一个不含 `await` 的提交段内更新其 Locale、`html.lang` 和 `html.dir=ltr`，并调用 Router Title 回调，成功后在该同步段清空匹配当前操作的待决目标；当前 Naive Component Locale 与所有 App Copy 从相同 Ref 在同一次 Vue Flush 投影。加载时仍渲染最后可用语言，不能显示一半新语言的树。Default Fallback 的单条安全中文是有意的缺译降级，不是允许异步混合语言。
...
Owner 已授权在同一实施内同步 §1.2B.3 唯一 JSON Source 与指定生成物；完整静态 Gate 已通过，当前 `21` 条为实现投影。§1.3 单独列出已实现的 Console I18n Scope，本实例之外的 I18n Target 仍保留适用边界。Manifest 从历史 `20` 增为当前 `21`，新增投影 ID `i18n`（唯一 Work-package ID 仍是 `PAVP_ADMIN_CONSOLE_LOCALIZATION`），其字段冻结为：
...
下面是本实例已获 Owner 实施授权的精确文件范围。范围中的 Source/Registry 变动必须与相应 Checker 同一任务落地；不要求每个无实际变化的派生文件产生 Diff。
...
| `package.json`; `pnpm-workspace.yaml`; `pnpm-lock.yaml`; `apps/web/package.json` | 仅上述 Runtime/Dev Dependency、Catalog 和正常生成的 Lock Closure；不添加新脚本体系或升级；Patch 仅限 §23.6.2 的显式声明兼容例外 |
...
后续实施先运行相关已有窄检查与 Typecheck，生成 Capability Output 后验证相等；最终完整运行 `mise exec -- pnpm verify`。依赖、资源和 Consumer Closure、Router/Kernel/Storage、UI Private Boundary、Type/Policy/Architecture/Generation、Unused Code、Production Build 和 Bundle Gate 都必须通过。Owner 为本次既有 Localization Implementation 明确批准 Initial JS 从 `237568`（`232 * 1024`）调整为精确 `245760`（`240 * 1024`）gzip bytes；CSS `40960`、普通 Lazy Route `122880`、Motion Feature `49152`、Generated Token Manifest `32768` gzip bytes 保持。最低 Initial JS Headroom 仍为 `8192`，故最大允许实际值为 `237568`；保留既有 SHA 归一化、gzip 参数、Appearance Initializer、共享 Chunk 去重、Static/Dynamic Closure、精确 Root Accounting、8 KiB Alignment 与历史 Baseline，不改成只比较更宽松的硬上限。

此批准仅扩展本实例的预算配置与静态交接范围：修改 `project.config.ts` 的唯一 Initial JS Budget Property、同步本文件直接受影响的现行预算/状态、修正 `check-router.ts` 的两处精确旧预算断言，并用现有 `generate-engineering-manifest.ts` 再生成 `engineering-manifest.ts`。直接过期的预算断言可作最小同步；`check-architecture-admin-console.ts` 的三条历史 Initial JS Marker 固定保留 `237568/14260/237568`，不得用当前配置重算历史。现有 `check-bundle.ts` 已按原公式计算本次 `245760`，其算法不变；`check-project-config.ts` 无需新增或放宽预算值。上述是 §23.6.2、§23.6.8 原范围的本次明确预算例外，不能推导为后续失败时自动上调预算的授权。

预算调整前本次复核的 `check:bundle` 以 Exit `1` 报告：实测 `232891`，原配置 `237568`，原算法要求 `245760`。旧预算仅有 `4677` 余量、差最低要求 `3515` 的失败继续作为历史事实；新预算在该测量下有 `12869` 余量，最终数值仍须完整 Production Build 与 Bundle Gate 复测。本次为 Owner 批准的产品预算调整，不是 Runtime Performance Optimization，也不使任何旧失败结果追溯变为通过。

独立 I18n Runtime 是首次 Mount 的必需按需资源，不是可省略的下载。Bundle 报告除原 Initial Static Closure 外，须列其闭包、当前中文 Route Resource 与恢复英文时所需 Resource 的实际 gzip 体积；不得用 Static Entry 未包含它来宣称启动下载体积不增加。实施的声明兼容、Build/Bundle 与 Runtime 行为分别由实际 Typecheck、完整静态 Gate 和 Owner 观察判断。除本节精确批准的预算调整外，不能通过抬高预算、移除失败检查、静默换库或扩展本实例范围解决失败。
...
PAVP_MOTION_GEOMETRY_STABILITY_REPAIR=COMPLETE
OWNER_MOTION_GEOMETRY_STABILITY_ACCEPTANCE=REVOKED_BY_EXACT_COMMIT_RUNTIME_AUDIT
VIEW_TRANSITION_STATUS=ACTIVE
VIEW_TRANSITION_MODE=PROGRESSIVE_ENHANCEMENT
VIEW_TRANSITION_ACTIVATION_STAGE=PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_SOURCE_IMPLEMENTATION
VIEW_TRANSITION_ACTIVATION_GATE_CREATION=PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_ADMISSION_AMENDMENT_FROZEN
...
这是技术路由优先级，不是当前依赖清单。Runtime Motion 一般能力与 GSAP 继续不激活；§1.2B.0M 已冻结并实现一个 Motion for Vue 私有 Shared-selection-lens 例外，其精确 scoped Runtime 为 `INSTALLED`，但不能扩张为 Public Platform API、其他 Consumer 或 Route-content Animation。§1.2B.0N 的 PAVP-owned Native Document View Transition Route Capability 仓库源码实施已完成，Canonical Static Verification 为 `PASS`；工作包现为 `ACCEPTED`，Publication 为 `COMPLETE`，已按精确 Owner 陈述登记 Runtime 与 Visual Acceptance 为 `PASS`，Accessibility 保持 `NOT_PERFORMED`；Current Work 为 `NONE`。它新增零依赖，不借用 Motion Vue、GSAP 或第二动画 Runtime 拥有 Route Content。第三方 Motion Vendor 只能由对应的 `packages/ui/src/adapters/**` 私有 Adapter 导入。

§1.2B.0E 只纠正当时的 CSS Motion Baseline Shell/Route Geometry，不激活 Runtime Motion、View Transition、Motion for Vue 或 GSAP；其中旧 Route Opacity 表述已由 PAVP-RUNTIME-005 的后续合同取代，不是当前 Authority。当前 `full`、`reduced` 与 `none` 保持相同的 Persistent Shell/Route Live DOM Geometry，Route Entry/Leave Live DOM Motion 与 Route Opacity Entry 均禁止；§1.2B.0N Admission Amendment 保留为准入实施的历史权威；Browser-created Static Pseudo-element Snapshot Transition 已完成仓库源码实施并通过 Canonical Static Verification，不再是 Future-only 或 Not-started 能力，现行工作包为 `ACCEPTED / COMPLETE / PASS`，精确实现已发布并登记限定 Owner Acceptance；先前 `OPEN / COMPLETE / PASS` 是发布前实施历史。
...
§1.2B.0I、§1.2B.0J 与 §1.2B.0K 曾串行保留一个 Admin Navigation 实例级 GSAP 例外；它们现在只保存精确历史决策、实现与测量证据。§1.2B.0L 的 Owner-directed Simplification 已退役该 Adapter、Dependency、Lazy Root、Budget 与全部运行时消费者，当前 `GSAP_STATUS=DEFERRED` 且 `GSAP_INSTANCE_ADMISSION_COUNT=0`。任何未来 Interaction 仍必须重新满足上方七项完整 Gate；历史例外不得被继承、恢复或解释为平台级 GSAP Capability。
...
当前 §23.6 Localization 扩展沿用上述 Owners，并由 `scripts/architecture/check-i18n.ts` 接入同一 `check:arch`：实际十二阶段 Kernel、三条 Storage Record、二十一条 Capability、十七条 Route 与二十六个 Dynamic Root 均由既有生产 Gate 闭合。上方 Router Landing 的原始计数不改写为该 Landing 的历史结果。
...
exact twelve-step Bootstrap Registry and acyclic dependency graph after the scoped Console I18n extension
exact Pinia-and-Appearance current provider set
unique Mount owner and exact reverse disposal order including dispose-i18n before dispose-storage
...
scoped Console I18n resource, typed boundary, locale preference and generated capability closure under Section 23.6
...
exact current-worktree 37-role public ID set, including 9 admitted layout roles and the admitted control-foreground role
...
MACHINE_GATES=§23.6.8 exact resource/import/interface/initialization/disposal/generation checks; existing strict type/policy/architecture/unused/build/bundle gates with the exact Section 23.6.9 approved Initial JS budget and every other budget and measurement rule unchanged; pnpm verify
...
CURRENT_RUNTIME_KERNEL_STEP_COUNT_IS_12
...
PAVP_NAIVE_COLLAPSIBLE_MULTILEVEL_NAVIGATION_REWORK_REPOSITORY_IMPLEMENTATION_IS_COMPLETE
PAVP_NAIVE_COLLAPSIBLE_MULTILEVEL_NAVIGATION_REWORK_STATIC_VERIFICATION_IS_PASS
PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_ADMISSION_AMENDMENT_IS_FROZEN
PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_REWORK_STATUS_IS_OPEN
PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_REWORK_REPOSITORY_IMPLEMENTATION_IS_COMPLETE
PAVP_ADMIN_NAVIGATION_INSET_ROUTE_SELECTION_AND_BOTTOM_COLLAPSE_DOCK_GSAP_REWORK_STATIC_VERIFICATION_IS_PASS
PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_ADMISSION_AMENDMENT_IS_FROZEN
PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_REWORK_STATUS_IS_OPEN
PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_REWORK_REPOSITORY_IMPLEMENTATION_IS_COMPLETE
PAVP_ADMIN_NAVIGATION_THEME_TINTED_SELECTION_AND_REFLOW_STABILITY_REWORK_STATIC_VERIFICATION_IS_PASS
PAVP_ADMIN_NAVIGATION_VISIBLE_HOVER_AND_UNIFIED_SELECTED_REVEAL_ADMISSION_AMENDMENT_IS_FROZEN
PAVP_ADMIN_NAVIGATION_VISIBLE_HOVER_AND_UNIFIED_SELECTED_REVEAL_REWORK_STATUS_IS_OPEN
PAVP_ADMIN_NAVIGATION_VISIBLE_HOVER_AND_UNIFIED_SELECTED_REVEAL_REWORK_REPOSITORY_IMPLEMENTATION_IS_NOT_STARTED
PAVP_ADMIN_NAVIGATION_VISIBLE_HOVER_AND_UNIFIED_SELECTED_REVEAL_REWORK_STATIC_VERIFICATION_IS_NOT_RUN
PAVP_ADMIN_NAVIGATION_NATIVE_NAIVE_SIMPLIFICATION_ADMISSION_AMENDMENT_IS_FROZEN
PAVP_ADMIN_NAVIGATION_NATIVE_NAIVE_SIMPLIFICATION_STATUS_IS_ACCEPTED
PAVP_ADMIN_NAVIGATION_NATIVE_NAIVE_SIMPLIFICATION_REPOSITORY_IMPLEMENTATION_IS_COMPLETE
PAVP_ADMIN_NAVIGATION_NATIVE_NAIVE_SIMPLIFICATION_STATIC_VERIFICATION_IS_PASS
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_ADMISSION_AMENDMENT_IS_FROZEN
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_STATUS_IS_ACCEPTED
...
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_OWNER_RUNTIME_ACCEPTANCE_IS_PASS
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_OWNER_VISUAL_ACCEPTANCE_IS_PASS
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_OWNER_ACCESSIBILITY_ACCEPTANCE_IS_NOT_PERFORMED
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_OWNER_ACCEPTANCE_STATEMENT_IS_效果还可以 可以接受
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_IMPLEMENTATION_COMMIT_IS_b6efbb608b309f601217a2765150bd9ec217cf78
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_PUBLICATION_TARGET_IS_ORIGIN_MAIN
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_PUBLICATION_STATUS_IS_COMPLETE
PAVP_ADMIN_NAVIGATION_MOTION_VUE_SHARED_SELECTION_LENS_RELEASE_STATUS_IS_NOT_RELEASED
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_ADMISSION_AMENDMENT_IS_FROZEN
CURRENT_BOUNDED_WORK_AUTHORITY_IS_NONE
CURRENT_BOUNDED_WORK_IS_NONE
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_STATUS_IS_ACCEPTED
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_REPOSITORY_IMPLEMENTATION_IS_COMPLETE
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_STATIC_VERIFICATION_IS_PASS
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_OWNER_RUNTIME_ACCEPTANCE_IS_PASS
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_OWNER_VISUAL_ACCEPTANCE_IS_PASS
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_OWNER_ACCESSIBILITY_ACCEPTANCE_IS_NOT_PERFORMED
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_PUBLICATION_STATUS_IS_COMPLETE
PAVP_ROUTE_TRANSITION_ROUTING_CAPABILITY_RELEASE_STATUS_IS_NOT_RELEASED
...
PAVP_RUNTIME_003_OWNER_ACCEPTANCE_STATEMENT_IS_那没问题
PAVP_RUNTIME_003_IMPLEMENTATION_COMMIT_IS_3fa078ab75322a17e5e4514d0805f1efea06981b
